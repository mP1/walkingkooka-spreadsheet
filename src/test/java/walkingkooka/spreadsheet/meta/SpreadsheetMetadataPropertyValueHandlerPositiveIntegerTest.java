...
public final class SpreadsheetMetadataPropertyValueHandlerPositiveIntegerTest extends SpreadsheetMetadataPropertyValueHandlerTestCase2<SpreadsheetMetadataPropertyValueHandlerPositiveInteger, Integer> {
    ...
    @Override
    SpreadsheetMetadataPropertyValueHandlerPositiveInteger handler() {
    ...
    @Override
    public Class<SpreadsheetMetadataPropertyValueHandlerPositiveInteger> type() {
        return SpreadsheetMetadataPropertyValueHandlerPositiveInteger.class;
    }
