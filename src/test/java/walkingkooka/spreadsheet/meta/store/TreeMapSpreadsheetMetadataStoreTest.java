...
public final class TreeMapSpreadsheetMetadataStoreTest extends SpreadsheetMetadataStoreTestCase<TreeMapSpreadsheetMetadataStore> {
    ...
    public void testToString() {
        ...
        this.toStringAndCheck(store, "[{create-date-time=1999-12-31T12:58:59, creator=user1@example.com, modified-by=modified@example.com, modified-date-time=2000-01-02T12:58:59, spreadsheet-id=1}, {create-date-time=1999-12-31T12:58:59, creator=user2@example.com, modified-by=modified@example.com, modified-date-time=2000-01-02T12:58:59, spreadsheet-id=2}]");
    }
