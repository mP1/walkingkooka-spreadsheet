...
public final class SpreadsheetMetadataPropertyValueHandlerSpreadsheetTextFormatterPatternFormatTest extends SpreadsheetMetadataPropertyValueHandlerTestCase2<SpreadsheetMetadataPropertyValueHandlerSpreadsheetTextFormatterPatternFormat, SpreadsheetTextFormatterPattern> {
    ...
    @Override
    SpreadsheetMetadataPropertyValueHandlerSpreadsheetTextFormatterPatternFormat handler() {
    ...
    @Override
    public Class<SpreadsheetMetadataPropertyValueHandlerSpreadsheetTextFormatterPatternFormat> type() {
        return SpreadsheetMetadataPropertyValueHandlerSpreadsheetTextFormatterPatternFormat.class;
    }
