...
public final class SpreadsheetMetadataPropertyValueHandlerRoundingModeTest extends SpreadsheetMetadataPropertyValueHandlerTestCase3<SpreadsheetMetadataPropertyValueHandlerRoundingMode, RoundingMode> {
    ...
    @Override
    SpreadsheetMetadataPropertyValueHandlerRoundingMode handler() {
    ...
    @Override
    public Class<SpreadsheetMetadataPropertyValueHandlerRoundingMode> type() {
        return SpreadsheetMetadataPropertyValueHandlerRoundingMode.class;
    }
}
