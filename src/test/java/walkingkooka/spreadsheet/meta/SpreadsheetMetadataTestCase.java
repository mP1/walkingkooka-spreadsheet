...
public abstract class SpreadsheetMetadataTestCase<T extends SpreadsheetMetadata> implements CanBeEmptyTesting,
    ...
    @Test
    public final void testSpreadsheetValidatorContextWithSpreadsheetMetadataLoaderFails() {
        assertThrows(
            NullPointerException.class,
            () -> this.createObject()
                .spreadsheetValidatorContext(
    ...
    @Test
    public final void testSpreadsheetValidatorContextWithCurrencyLocaleContextFails() {
        assertThrows(
            NullPointerException.class,
            () -> this.createObject()
                .spreadsheetValidatorContext(
