...
public final class SpreadsheetMetadataPropertyNameSpreadsheetParserAliasSetParsersTest extends SpreadsheetMetadataPropertyNameSpreadsheetParserAliasSetTestCase<SpreadsheetMetadataPropertyNameSpreadsheetParserAliasSetParsers> {
    ...
    @Override
    SpreadsheetMetadataPropertyNameSpreadsheetParserAliasSetParsers createName() {
        return SpreadsheetMetadataPropertyNameSpreadsheetParserAliasSetParsers.instance();
    }
    ...
    @Override
    public Class<SpreadsheetMetadataPropertyNameSpreadsheetParserAliasSetParsers> type() {
        return SpreadsheetMetadataPropertyNameSpreadsheetParserAliasSetParsers.class;
    }
}
