...
public final class TwoDigitYearSpreadsheetMetadataPropertyValueHandlerTest extends SpreadsheetMetadataPropertyValueHandlerTestCase2<TwoDigitYearSpreadsheetMetadataPropertyValueHandler, Integer> {
    ...
    @Override
    TwoDigitYearSpreadsheetMetadataPropertyValueHandler handler() {
    ...
    @Override
    public Class<TwoDigitYearSpreadsheetMetadataPropertyValueHandler> type() {
        return TwoDigitYearSpreadsheetMetadataPropertyValueHandler.class;
    }
