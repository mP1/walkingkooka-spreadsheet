...
public final class DateSpreadsheetParserTokenTest extends ValueSpreadsheetParserTokenTestCase<DateSpreadsheetParserToken> {
    ...
    private void testToLocalDateAndCheck(final ExpressionEvaluationContext context,
        ...
        final DateSpreadsheetParserToken dateParserToken = DateSpreadsheetParserToken.with(
                tokensList,
    ...
    @Override
    DateSpreadsheetParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public DateSpreadsheetParserToken createDifferentToken() {
    ...
    @Override
    public Class<DateSpreadsheetParserToken> type() {
        return DateSpreadsheetParserToken.class;
    }

    @Override
    public DateSpreadsheetParserToken unmarshall(final JsonNode from,
