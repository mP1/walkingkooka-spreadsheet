...
public final class SubtractionSpreadsheetParserTokenTest extends ArithmeticSpreadsheetParserTokenTestCase<SubtractionSpreadsheetParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SubtractionSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SubtractionSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    SubtractionSpreadsheetParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<SubtractionSpreadsheetParserToken> type() {
        return SubtractionSpreadsheetParserToken.class;
    }

    @Override
    public SubtractionSpreadsheetParserToken unmarshall(final JsonNode from,
                                                        final JsonNodeUnmarshallContext context) {
        return SpreadsheetParserToken.unmarshallSubtraction(from, context);
    }
}
