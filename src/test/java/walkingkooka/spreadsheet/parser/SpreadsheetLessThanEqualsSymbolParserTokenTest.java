...
public final class SpreadsheetLessThanEqualsSymbolParserTokenTest extends SpreadsheetSymbolParserTokenTestCase<SpreadsheetLessThanEqualsSymbolParserToken> {
    ...
    @Override
    SpreadsheetLessThanEqualsSymbolParserToken createToken(final String value, final String text) {
        return SpreadsheetLessThanEqualsSymbolParserToken.with(value, text);
    }

    @Override
    public SpreadsheetLessThanEqualsSymbolParserToken createDifferentToken() {
        return SpreadsheetLessThanEqualsSymbolParserToken.with(this.text(), "different");
    }

    @Override
    public Class<SpreadsheetLessThanEqualsSymbolParserToken> type() {
        return SpreadsheetLessThanEqualsSymbolParserToken.class;
    }

    @Override
    public SpreadsheetLessThanEqualsSymbolParserToken unmarshall(final JsonNode from,
