...
public final class SpreadsheetBigDecimalParserTokenTest extends SpreadsheetNonSymbolParserTokenTestCase<SpreadsheetBigDecimalParserToken, BigDecimal> {
    ...
    public void testToExpression() {
        this.toExpressionAndCheck(Expression.bigDecimal(this.value()));
    }
    ...
    @Override
    SpreadsheetBigDecimalParserToken createToken(final BigDecimal value, final String text) {
        return SpreadsheetBigDecimalParserToken.with(value, text);
    }

    @Override
    public SpreadsheetBigDecimalParserToken createDifferentToken() {
        return SpreadsheetBigDecimalParserToken.with(new BigDecimal(-1), "'different'");
    }

    @Override
    public Class<SpreadsheetBigDecimalParserToken> type() {
