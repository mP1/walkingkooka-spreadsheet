...
public final class LessThanSpreadsheetParserTokenTest extends ConditionSpreadsheetParserTokenTestCase<LessThanSpreadsheetParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final LessThanSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final LessThanSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    LessThanSpreadsheetParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<LessThanSpreadsheetParserToken> type() {
        return LessThanSpreadsheetParserToken.class;
    }

    @Override
    public LessThanSpreadsheetParserToken unmarshall(final JsonNode from,
                                                     final JsonNodeUnmarshallContext context) {
        return SpreadsheetParserToken.unmarshallLessThan(from, context);
    }
}
