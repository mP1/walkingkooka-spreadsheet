...
public final class SpreadsheetPowerParserTokenTest extends SpreadsheetArithmeticParserTokenTestCase<SpreadsheetPowerParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SpreadsheetPowerParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SpreadsheetPowerParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    public SpreadsheetPowerParserToken unmarshall(final JsonNode from,
