...
public final class SpreadsheetGreaterThanParserTokenTest extends SpreadsheetConditionParserTokenTestCase<SpreadsheetGreaterThanParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SpreadsheetGreaterThanParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SpreadsheetGreaterThanParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    SpreadsheetGreaterThanParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public SpreadsheetGreaterThanParserToken unmarshall(final JsonNode from,
