...
public final class SpreadsheetGreaterThanEqualsParserTokenTest extends SpreadsheetConditionParserTokenTestCase<SpreadsheetGreaterThanEqualsParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SpreadsheetGreaterThanEqualsParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SpreadsheetGreaterThanEqualsParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    public SpreadsheetGreaterThanEqualsParserToken unmarshall(final JsonNode from,
