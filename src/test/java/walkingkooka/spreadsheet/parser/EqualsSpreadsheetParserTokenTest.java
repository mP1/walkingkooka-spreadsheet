...
public final class EqualsSpreadsheetParserTokenTest extends ConditionSpreadsheetParserTokenTestCase<EqualsSpreadsheetParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final EqualsSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final EqualsSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    EqualsSpreadsheetParserToken createToken(final String text, final List<ParserToken> tokens) {
        return SpreadsheetParserToken.equalsSpreadsheetParserToken(tokens, text);
    }
    ...
    @Override
    public Class<EqualsSpreadsheetParserToken> type() {
        return EqualsSpreadsheetParserToken.class;
    }

    @Override
    public EqualsSpreadsheetParserToken unmarshall(final JsonNode from,
