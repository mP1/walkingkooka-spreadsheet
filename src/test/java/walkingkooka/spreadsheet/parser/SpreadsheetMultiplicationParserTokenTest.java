...
public final class SpreadsheetMultiplicationParserTokenTest extends SpreadsheetArithmeticParserTokenTestCase<SpreadsheetMultiplicationParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SpreadsheetMultiplicationParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SpreadsheetMultiplicationParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    public SpreadsheetMultiplicationParserToken unmarshall(final JsonNode from,
