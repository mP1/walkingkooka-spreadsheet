...
public final class SpreadsheetLessThanParserTokenTest extends SpreadsheetConditionParserTokenTestCase<SpreadsheetLessThanParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SpreadsheetLessThanParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SpreadsheetLessThanParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    SpreadsheetLessThanParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<SpreadsheetLessThanParserToken> type() {
        return SpreadsheetLessThanParserToken.class;
    }

    @Override
    public SpreadsheetLessThanParserToken unmarshall(final JsonNode from,
