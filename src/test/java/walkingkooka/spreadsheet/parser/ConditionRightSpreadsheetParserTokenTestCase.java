...
public abstract class ConditionRightSpreadsheetParserTokenTestCase<T extends ConditionRightSpreadsheetParserToken> extends ParentSpreadsheetParserTokenTestCase<T> {
    ConditionRightSpreadsheetParserTokenTestCase() {
        super();
    }
    ...
    final void setConditionLeftAndCheck(final T token,
                                        ...
                                        final ConditionSpreadsheetParserToken expected) {
        this.checkEquals(
                expected,
    ...
    abstract SymbolSpreadsheetParserToken symbolParserToken();
