...
public final class SpreadsheetLessThanEqualsParserTokenTest extends SpreadsheetConditionParserTokenTestCase<SpreadsheetLessThanEqualsParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SpreadsheetLessThanEqualsParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SpreadsheetLessThanEqualsParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    SpreadsheetLessThanEqualsParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<SpreadsheetLessThanEqualsParserToken> type() {
        return SpreadsheetLessThanEqualsParserToken.class;
    }

    @Override
    public SpreadsheetLessThanEqualsParserToken unmarshall(final JsonNode from,
