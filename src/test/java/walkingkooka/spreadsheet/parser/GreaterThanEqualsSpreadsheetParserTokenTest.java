...
public final class GreaterThanEqualsSpreadsheetParserTokenTest extends ConditionSpreadsheetParserTokenTestCase<GreaterThanEqualsSpreadsheetParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final GreaterThanEqualsSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final GreaterThanEqualsSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
            ...
            @Override
            protected void visit(final GreaterThanEqualsSymbolSpreadsheetParserToken t) {
                b.append("7");
                visited.add(t);
            }
    ...
    @Override
    GreaterThanEqualsSpreadsheetParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<GreaterThanEqualsSpreadsheetParserToken> type() {
        return GreaterThanEqualsSpreadsheetParserToken.class;
    }

    @Override
    public GreaterThanEqualsSpreadsheetParserToken unmarshall(final JsonNode from,
                                                              final JsonNodeUnmarshallContext context) {
        return SpreadsheetParserToken.unmarshallGreaterThanEquals(from, context);
    }
}
