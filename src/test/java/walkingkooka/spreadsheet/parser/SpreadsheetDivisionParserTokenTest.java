...
public final class SpreadsheetDivisionParserTokenTest extends SpreadsheetArithmeticParserTokenTestCase<SpreadsheetDivisionParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SpreadsheetDivisionParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SpreadsheetDivisionParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    public SpreadsheetDivisionParserToken unmarshall(final JsonNode from,
