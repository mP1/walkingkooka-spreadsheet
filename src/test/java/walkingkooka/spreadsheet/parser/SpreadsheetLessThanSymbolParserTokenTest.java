...
public final class SpreadsheetLessThanSymbolParserTokenTest extends SpreadsheetSymbolParserTokenTestCase<SpreadsheetLessThanSymbolParserToken> {
    ...
    @Override
    public Class<SpreadsheetLessThanSymbolParserToken> type() {
        return SpreadsheetLessThanSymbolParserToken.class;
    }

    @Override
    public SpreadsheetLessThanSymbolParserToken unmarshall(final JsonNode from,
