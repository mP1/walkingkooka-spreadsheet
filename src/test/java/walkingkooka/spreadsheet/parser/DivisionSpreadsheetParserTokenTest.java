...
public final class DivisionSpreadsheetParserTokenTest extends ArithmeticSpreadsheetParserTokenTestCase<DivisionSpreadsheetParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final DivisionSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final DivisionSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    DivisionSpreadsheetParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<DivisionSpreadsheetParserToken> type() {
        return DivisionSpreadsheetParserToken.class;
    }

    @Override
    public DivisionSpreadsheetParserToken unmarshall(final JsonNode from,
                                                     final JsonNodeUnmarshallContext context) {
        return SpreadsheetParserToken.unmarshallDivision(from, context);
    }
}
