...
public final class LessThanEqualsSpreadsheetParserTokenTest extends ConditionSpreadsheetParserTokenTestCase<LessThanEqualsSpreadsheetParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final LessThanEqualsSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final LessThanEqualsSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    LessThanEqualsSpreadsheetParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<LessThanEqualsSpreadsheetParserToken> type() {
        return LessThanEqualsSpreadsheetParserToken.class;
    }

    @Override
    public LessThanEqualsSpreadsheetParserToken unmarshall(final JsonNode from,
                                                           final JsonNodeUnmarshallContext context) {
        return SpreadsheetParserToken.unmarshallLessThanEquals(from, context);
    }
}
