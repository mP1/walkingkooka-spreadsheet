...
public final class SpreadsheetNotEqualsParserTokenTest extends SpreadsheetConditionParserTokenTestCase<SpreadsheetNotEqualsParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SpreadsheetNotEqualsParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SpreadsheetNotEqualsParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    SpreadsheetNotEqualsParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<SpreadsheetNotEqualsParserToken> type() {
        return SpreadsheetNotEqualsParserToken.class;
    }

    @Override
    public SpreadsheetNotEqualsParserToken unmarshall(final JsonNode from,
