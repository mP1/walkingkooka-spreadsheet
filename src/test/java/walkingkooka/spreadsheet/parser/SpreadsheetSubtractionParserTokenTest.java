...
public final class SpreadsheetSubtractionParserTokenTest extends SpreadsheetArithmeticParserTokenTestCase<SpreadsheetSubtractionParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SpreadsheetSubtractionParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SpreadsheetSubtractionParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    public SpreadsheetSubtractionParserToken unmarshall(final JsonNode from,
