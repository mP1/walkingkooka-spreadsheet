...
public final class SpreadsheetTimeParserTokenTest extends SpreadsheetValueParserTokenTestCase<SpreadsheetTimeParserToken> {
    ...
    @Override
    SpreadsheetTimeParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public SpreadsheetTimeParserToken createDifferentToken() {
    ...
    @Override
    public Class<SpreadsheetTimeParserToken> type() {
        return SpreadsheetTimeParserToken.class;
    }

    @Override
    public SpreadsheetTimeParserToken unmarshall(final JsonNode from,
