...
public final class SpreadsheetHateosResourceNamesTest implements PublicStaticHelperTesting<SpreadsheetHateosResourceNames>,
    ...
    @Override
    public Set<SpreadsheetHateosResourceNames> intentionalDuplicateConstants() {
        return Sets.empty();
    }
    ...
    @Override
    public Class<SpreadsheetHateosResourceNames> type() {
        return SpreadsheetHateosResourceNames.class;
    }
