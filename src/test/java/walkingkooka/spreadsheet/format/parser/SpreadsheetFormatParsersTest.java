...
public final class SpreadsheetFormatParsersTest extends SpreadsheetFormatParserTestCase implements PublicStaticHelperTesting<SpreadsheetFormatParsers>,
    ...
    public void testDateFormatSeparatorFails() {
        this.dateFormatParseThrows(
                ...
                "Invalid character ';' at (1,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testDateFormatTextDigitZeroFails() {
        this.dateFormatParseThrows(
                digitZero(),
                "Invalid character '0' at (1,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testDateFormatHourFails() {
        this.dateFormatParseThrows(
                hour(),
                "Invalid character 'H' at (1,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testDateFormatSecondFails() {
        this.dateFormatParseThrows(
                second(),
                "Invalid character 'S' at (1,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testDateFormatDayEqualsMonthYearFails() {
        this.dateFormatParseThrows(
                ...
                "Invalid character '=' at (2,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testDateFormatDayMonthEqualsYearFails() {
        this.dateFormatParseThrows(
                ...
                "Invalid character '=' at (3,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testDateFormatDayMonthYearEqualsFails() {
        this.dateFormatParseThrows(
                ...
                "Invalid character '=' at (4,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testDateParseColorEscapedFails() {
        this.dateParseParseThrows(
                ...
                "Invalid character '[' at (1,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testDateParseTextDigitZeroFails() {
        this.dateParseParseThrows(
                digitZero(),
                "Invalid character '0' at (1,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testDateParseHourFails() {
        this.dateParseParseThrows(
                hour(),
                "Invalid character 'H' at (1,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testDateParseSecondFails() {
        this.dateParseParseThrows(
                second(),
                "Invalid character 'S' at (1,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testDateParseDayEqualsMonthYearFails() {
        this.dateParseParseThrows(
                ...
                "Invalid character '=' at (2,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testDateParseDayMonthEqualsYearFails() {
        this.dateParseParseThrows(
                ...
                "Invalid character '=' at (3,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testDateParseDayMonthYearEqualsFails() {
        this.dateParseParseThrows(
                ...
                "Invalid character '=' at (4,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testNumberFormatDayFails() {
        this.numberFormatParseThrows(
                digit(),
                day(),
                "Invalid character 'D' at (2,1) expected (([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]))"
        );
    }
    ...
    public void testNumberFormatHourFails() {
        this.numberFormatParseThrows(
                digit(),
                hour(),
                "Invalid character 'H' at (2,1) expected (([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]))"
        );
    }
    ...
    public void testNumberFormatMinuteFails() {
        this.numberFormatParseThrows(
                digit(),
                minute(),
                "Invalid character 'M' at (2,1) expected (([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]))"
        );
    }
    ...
    public void testNumberFormatSecondFails() {
        this.numberFormatParseThrows(
                digit(),
                second(),
                "Invalid character 'S' at (2,1) expected (([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]))"
        );
    }
    ...
    public void testNumberFormatStarFails() {
        this.numberFormatParseThrows(
                star(),
                "Invalid character '*' at (1,1) expected (([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]))"
        );
    }
    ...
    public void testNumberFormatTextPlaceholderFails() {
        this.numberFormatParseThrows(
                digit(),
                textPlaceholder(),
                "Invalid character '@' at (2,1) expected (([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]))"
        );
    }
    ...
    public void testNumberFormatUnderscoreFails() {
        this.numberFormatParseThrows(
                underscore(),
                "Invalid character '_' at (1,1) expected (([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]))"
        );
    }
    ...
    public void testNumberFormatYearFails() {
        this.numberFormatParseThrows(
                digit(),
                year(),
                "Invalid character 'Y' at (2,1) expected (([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]))"
        );
    }
    ...
    public void testNumberFormatPatternSeparatorTextPatternSeparatorFails() {
        this.numberFormatParseThrows(
                ...
                "Invalid character ';' at (4,1) expected (([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]))"
        );
    }
    ...
    public void testNumberFormatPatternSeparatorPatternSeparatorTextPatternSeparatorFails() {
        this.numberFormatParseThrows(
                ...
                "Invalid character ';' at (6,1) expected (([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]))"
        );
    }
    ...
    public void testNumberFormatPatternSeparatorPatternSeparatorPatternSeparatorTextPatternSeparatorFails() {
        this.numberFormatParseThrows(
                ...
                "Invalid character ';' at (8,1) expected (([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]))"
        );
    }
    ...
    public void testNumberFormatPatternSeparatorPatternSeparatorPatternSeparatorConditionPatternFails() {
        this.numberFormatParseThrows(
                ...
                "Invalid character '@' at (18,1) expected (([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})])], \";\", [(([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]) | (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}))]) | ([((\"[\", [WHITESPACE], \"=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<>\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \">\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<=\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\") | (\"[\", [WHITESPACE], \"<\", [WHITESPACE], CONDITION_NUMBER, [WHITESPACE], \"]\"))], [(([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | COLOR)}]))})]))"
        );
    }
    ...
    public void testNumberParseDayFails() {
        this.numberParseParseThrows(
                digit(),
                day(),
                "Invalid character 'D' at (2,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}))}], [\";\"])"
        );
    }
    ...
    public void testNumberParseHourFails() {
        this.numberParseParseThrows(
                digit(),
                hour(),
                "Invalid character 'H' at (2,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}))}], [\";\"])"
        );
    }
    ...
    public void testNumberParseMonthFails() {
        this.numberParseParseThrows(
                digit(),
                month(),
                "Invalid character 'M' at (2,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}))}], [\";\"])"
        );
    }
    ...
    public void testNumberParseSecondFails() {
        this.numberParseParseThrows(
                digit(),
                second(),
                "Invalid character 'S' at (2,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}))}], [\";\"])"
        );
    }
    ...
    public void testNumberParseStarFails() {
        this.numberParseParseThrows(
                star(),
                "Invalid character '*' at (1,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}))}], [\";\"])"
        );
    }
    ...
    public void testNumberParseTextPlaceholderFails() {
        this.numberParseParseThrows(
                digit(),
                textPlaceholder(),
                "Invalid character '@' at (2,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}))}], [\";\"])"
        );
    }
    ...
    public void testNumberParseUnderscoreFails() {
        this.numberParseParseThrows(
                underscore(),
                "Invalid character '_' at (1,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}))}], [\";\"])"
        );
    }
    ...
    public void testNumberParseYearFails() {
        this.numberParseParseThrows(
                digit(),
                year(),
                "Invalid character 'Y' at (2,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}))}], [\";\"])"
        );
    }
    ...
    public void testNumberParseDigitDecimalColorFails() {
        this.numberParseParseThrows(
                ...
                "Invalid character '[' at (3,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}))}], [\";\"])"
        );
    }
    ...
    public void testNumberParseDigitDecimalDigitColorFails() {
        this.numberParseParseThrows(
                ...
                "Invalid character '[' at (4,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}))}], [\";\"])"
        );
    }
    ...
    public void testNumberParseDigitExponentDigitColorDigitFails() {
        this.numberParseParseThrows(
                ...
                "Invalid character '[' at (5,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}))}], [\";\"])"
        );
    }
    ...
    public void testNumberParseDigitExponentDigitColorFails() {
        this.numberParseParseThrows(
                ...
                "Invalid character '[' at (7,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(\"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED | ((\"E+\" | \"e+\" | \"E-\" | \"e-\"), [{(\".\" | \"#\" | \"?\" | \"0\" | \",\" | \"$\" | \".\" | ESCAPE | \"#\" | \"?\" | \"0\" | \",\" | NUMBER_LITERAL | \"%\" | QUOTED)}]))}))}], [\";\"])"
        );
    }
    ...
    public void testTextFormatSeparatorFails() {
        this.textFormatParseThrows(
                separator(),
                "Invalid character ';' at (1,1) expected (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)})"
        );
    }
    ...
    public void testTextFormatTextDigitZeroFails() {
        this.textFormatParseThrows(
                digitZero(),
                "Invalid character '0' at (1,1) expected (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)})"
        );
    }
    ...
    public void testTextFormatLetterFails() {
        this.textFormatParseThrows(
                textLiteral('A'),
                "Invalid character 'A' at (1,1) expected (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)})"
        );
    }
    ...
    public void testTextFormatGeneraFails() {
        this.textFormatParseThrows(
                generalSymbol(),
                "Invalid character 'G' at (1,1) expected (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)})"
        );
    }
    ...
    public void testTextFormatStarStarFails() {
        this.textFormatParseThrows(
                star(),
                star2(),
                "Invalid character '*' at (3,1) expected (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)})"
        );
    }
    ...
    public void testTextFormatStarTextPlaceholderStarFails() {
        this.textFormatParseThrows(
                ...
                "Invalid character '*' at (4,1) expected (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)})"
        );
    }
    ...
    public void testTextFormatConditionEqualsFails() {
        this.textFormatParseThrows(
                textPlaceholder(),
                conditionEquals(),
                "Invalid character '[' at (2,1) expected (([{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}], STAR, [{(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)}]) | {(COLOR | {(\" \" | \"<\" | \">\" | \"=\" | \"!\" | \"$\" | \"-\" | \"+\" | \"(\" | \")\" | \"%\" | \"&\" | \"/\" | \",\" | \":\")} | ESCAPE | QUOTED | \"@\" | UNDERSCORE)})"
        );
    }
    ...
    public void testTimeFormatSeparatorFails() {
        this.timeFormatParseThrows(
                separator(),
                "Invalid character ';' at (1,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testTimeFormatTextDigitZeroFails() {
        this.timeFormatParseThrows(
                digitZero(),
                "Invalid character '0' at (1,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testTimeFormatDayFails() {
        this.timeFormatParseThrows(
                day(),
                "Invalid character 'D' at (1,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testTimeFormatYearFails() {
        this.timeFormatParseThrows(
                year(),
                "Invalid character 'Y' at (1,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testTimeFormatHourEqualsMinuteSecondFails() {
        this.timeFormatParseThrows(
                ...
                "Invalid character '=' at (2,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testTimeFormatHourMinuteEqualsSecondFails() {
        this.timeFormatParseThrows(
                ...
                "Invalid character '=' at (3,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testTimeFormatHourMinuteSecondsEqualsFails() {
        this.timeFormatParseThrows(
                ...
                "Invalid character '=' at (4,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testTimeFormatColorPatternSeparatorPatternFails() {
        this.timeFormatParseThrows(
                ...
                "Invalid character ';' at (14,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testTimeParseTextDigitFails() {
        this.timeParseParseThrows(
                digit(),
                "Invalid character '#' at (1,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testTimeParseTextDigitZeroFails() {
        this.timeParseParseThrows(
                digitZero(),
                "Invalid character '0' at (1,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testTimeParseDayFails() {
        this.timeParseParseThrows(
                day(),
                "Invalid character 'D' at (1,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testTimeParseYearFails() {
        this.timeParseParseThrows(
                year(),
                "Invalid character 'Y' at (1,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testTimeParseHourEqualsMinuteSecondFails() {
        this.timeParseParseThrows(
                ...
                "Invalid character '=' at (2,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testTimeParseHourMinuteEqualsSecondFails() {
        this.timeParseParseThrows(
                ...
                "Invalid character '=' at (3,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testTimeParseHourMinuteSecondsEqualsFails() {
        this.timeParseParseThrows(
                ...
                "Invalid character '=' at (4,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"H\"} | {\"M\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testDateTimeFormatSeparatorFails() {
        this.dateTimeFormatParseThrows(
                separator(),
                "Invalid character ';' at (1,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"D\"} | {\"M\"} | {\"Y\"} | {\"H\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testDateTimeFormatSecondsDecimalNonZeroFails() {
        this.dateTimeFormatParseThrows(
                ...
                "Invalid character '#' at (3,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"D\"} | {\"M\"} | {\"Y\"} | {\"H\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testDateTimeFormatDayConditionFails() {
        this.dateTimeFormatParseThrows(
                day(),
                conditionEquals(),
                "Invalid character '[' at (2,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"D\"} | {\"M\"} | {\"Y\"} | {\"H\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testDateTimeFormatPatternSeparatorFails() {
        this.dateTimeFormatParseThrows(
                ...
                separator(),
                "Invalid character ';' at (6,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"D\"} | {\"M\"} | {\"Y\"} | {\"H\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testDateTimeFormatColorPatternSeparatorPatternFails() {
        this.dateTimeFormatParseThrows(
                ...
                "Invalid character ';' at (17,1) expected (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {(COLOR | {\"D\"} | {\"M\"} | {\"Y\"} | {\"H\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)})"
        );
    }
    ...
    public void testDateTimeParseColorEscapedFails() {
        this.dateTimeParseParseThrows(
                ...
                "Invalid character '[' at (1,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | {\"H\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | {\"H\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testDateTimeParseSecondsDecimalNonZeroFails() {
        this.dateTimeParseParseThrows(
                ...
                "Invalid character '#' at (3,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | {\"H\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | {\"H\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
    ...
    public void testDateTimeParseDayColorFails() {
        this.dateTimeParseParseThrows(
                ...
                "Invalid character '[' at (2,1) expected ((([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | {\"H\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}), [{(\";\", (([{(WHITESPACE | COLOR)}], GENERAL, [{(WHITESPACE | COLOR)}]) | {({\"D\"} | {\"M\"} | {\"Y\"} | {\"H\"} | ({\"S\"}, [(\".\", [{\"0\"}])]) | \"AM/PM\" | \"A/P\" | ESCAPE | DATETIME_TEXT_LITERAL | QUOTED)}))}], [\";\"])"
        );
    }
