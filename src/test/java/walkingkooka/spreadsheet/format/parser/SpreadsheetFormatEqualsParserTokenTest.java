...
public final class SpreadsheetFormatEqualsParserTokenTest extends SpreadsheetFormatConditionParserTokenTestCase<SpreadsheetFormatEqualsParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetFormatParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SpreadsheetFormatEqualsParserToken t) {
                assertSame(token, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SpreadsheetFormatEqualsParserToken t) {
                assertSame(token, t);
                b.append("4");
                visited.add(t);
            }
            ...
            @Override
            protected void visit(final SpreadsheetFormatEqualsSymbolParserToken t) {
    ...
    @Override
    SpreadsheetFormatEqualsParserToken createToken(final String text, final List<ParserToken> tokens) {
        return SpreadsheetFormatParserToken.equalsParserToken(tokens, text);
    }
    ...
    @Override
    public SpreadsheetFormatEqualsParserToken unmarshall(final JsonNode node,
