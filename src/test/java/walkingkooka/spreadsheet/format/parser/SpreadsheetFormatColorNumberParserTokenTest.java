...
public final class SpreadsheetFormatColorNumberParserTokenTest extends SpreadsheetFormatNonSymbolParserTokenTestCase<SpreadsheetFormatColorNumberParserToken, Integer> {
    ...
    public void testAccept() {
        ...
        final SpreadsheetFormatColorNumberParserToken token = this.createToken();
        ...
        new FakeSpreadsheetFormatParserTokenVisitor() {
            ...
            @Override
            protected void visit(final SpreadsheetFormatColorNumberParserToken t) {
                assertSame(token, t);
                b.append("5");
            }
        }.accept(token);
    ...
    @Override
    public Class<SpreadsheetFormatColorNumberParserToken> type() {
        return SpreadsheetFormatColorNumberParserToken.class;
    }

    @Override
    public SpreadsheetFormatColorNumberParserToken unmarshall(final JsonNode node,
