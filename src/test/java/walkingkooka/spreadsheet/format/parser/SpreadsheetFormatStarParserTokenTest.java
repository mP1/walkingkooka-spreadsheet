...
public final class SpreadsheetFormatStarParserTokenTest extends SpreadsheetFormatNonSymbolParserTokenTestCase<SpreadsheetFormatStarParserToken, Character> {

    @Test
    public void testAccept() {
        final StringBuilder b = new StringBuilder();
        final SpreadsheetFormatStarParserToken token = this.createToken();
        ...
        new FakeSpreadsheetFormatParserTokenVisitor() {
            ...
            @Override
            protected void visit(final SpreadsheetFormatStarParserToken t) {
                assertSame(token, t);
                b.append("5");
            }
        }.accept(token);
    ...
    @Override
    public SpreadsheetFormatStarParserToken unmarshall(final JsonNode node,
