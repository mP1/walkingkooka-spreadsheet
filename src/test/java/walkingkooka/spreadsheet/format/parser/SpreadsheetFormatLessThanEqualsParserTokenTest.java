...
public final class SpreadsheetFormatLessThanEqualsParserTokenTest extends SpreadsheetFormatConditionParserTokenTestCase<SpreadsheetFormatLessThanEqualsParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetFormatParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SpreadsheetFormatLessThanEqualsParserToken t) {
                assertSame(token, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SpreadsheetFormatLessThanEqualsParserToken t) {
                assertSame(token, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    SpreadsheetFormatLessThanEqualsParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public SpreadsheetFormatLessThanEqualsParserToken unmarshall(final JsonNode node,
