...
public final class GeneralSpreadsheetFormatParserTokenTest extends ParentSpreadsheetFormatParserTokenTestCase<GeneralSpreadsheetFormatParserToken> {
    ...
    public void testAccept() {
        ...
        final GeneralSpreadsheetFormatParserToken token = this.createToken();
        ...
        new FakeSpreadsheetFormatParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final GeneralSpreadsheetFormatParserToken t) {
                assertSame(token, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final GeneralSpreadsheetFormatParserToken t) {
                assertSame(token, t);
                b.append("4");
                visited.add(t);
            }
            ...
            @Override
            protected void visit(final GeneralSymbolSpreadsheetFormatParserToken t) {
    ...
    @Override
    GeneralSpreadsheetFormatParserToken createToken(final String text, final List<ParserToken> tokens) {
        return GeneralSpreadsheetFormatParserToken.with(tokens, text);
    }
    ...
    @Override
    public Class<GeneralSpreadsheetFormatParserToken> type() {
        return GeneralSpreadsheetFormatParserToken.class;
    }

    @Override
    public GeneralSpreadsheetFormatParserToken unmarshall(final JsonNode node,
                                                          final JsonNodeUnmarshallContext context) {
        return SpreadsheetFormatParserToken.unmarshallGeneral(node, context);
    }
}
