...
public final class SpreadsheetFormatColorLiteralSymbolParserTokenTest extends SpreadsheetFormatSymbolParserTokenTestCase<SpreadsheetFormatColorLiteralSymbolParserToken> {

    @Test
    public void testAccept() {
        final StringBuilder b = new StringBuilder();
        final SpreadsheetFormatColorLiteralSymbolParserToken token = this.createToken();
        ...
        new FakeSpreadsheetFormatParserTokenVisitor() {
            ...
            @Override
            protected void visit(final SpreadsheetFormatColorLiteralSymbolParserToken t) {
                assertSame(token, t);
                b.append("5");
            }
        }.accept(token);
    ...
    @Override
    public SpreadsheetFormatColorLiteralSymbolParserToken unmarshall(final JsonNode node,
