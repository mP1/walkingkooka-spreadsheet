...
public final class SpreadsheetFormatDecimalPointParserTokenTest extends SpreadsheetFormatNonSymbolParserTokenTestCase<SpreadsheetFormatDecimalPointParserToken, String> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetFormatParserTokenVisitor() {
            ...
            @Override
            protected void visit(final SpreadsheetFormatDecimalPointParserToken t) {
                assertSame(token, t);
                b.append("5");
            }
        }.accept(token);
    ...
    @Override
    public SpreadsheetFormatDecimalPointParserToken unmarshall(final JsonNode node,
