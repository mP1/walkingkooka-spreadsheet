...
public final class SpreadsheetFormatNotEqualsParserTokenTest extends SpreadsheetFormatConditionParserTokenTestCase<SpreadsheetFormatNotEqualsParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetFormatParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SpreadsheetFormatNotEqualsParserToken t) {
                assertSame(token, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SpreadsheetFormatNotEqualsParserToken t) {
                assertSame(token, t);
                b.append("4");
                visited.add(t);
            }
            ...
            @Override
            protected void visit(final SpreadsheetFormatNotEqualsSymbolParserToken t) {
    ...
    @Override
    SpreadsheetFormatNotEqualsParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<SpreadsheetFormatNotEqualsParserToken> type() {
        return SpreadsheetFormatNotEqualsParserToken.class;
    }

    @Override
    public SpreadsheetFormatNotEqualsParserToken unmarshall(final JsonNode node,
