...
public final class SpreadsheetFormatNotEqualsSymbolParserTokenTest extends SpreadsheetFormatSymbolParserTokenTestCase<SpreadsheetFormatNotEqualsSymbolParserToken> {
    ...
    @Override
    public SpreadsheetFormatNotEqualsSymbolParserToken unmarshall(final JsonNode node,
