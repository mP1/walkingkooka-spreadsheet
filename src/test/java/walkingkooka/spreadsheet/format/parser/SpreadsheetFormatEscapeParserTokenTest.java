...
public final class SpreadsheetFormatEscapeParserTokenTest extends SpreadsheetFormatNonSymbolParserTokenTestCase<SpreadsheetFormatEscapeParserToken, Character> {

    @Test
    public void testAccept() {
        final StringBuilder b = new StringBuilder();
        final SpreadsheetFormatEscapeParserToken token = this.createToken();
        ...
        new FakeSpreadsheetFormatParserTokenVisitor() {
            ...
            @Override
            protected void visit(final SpreadsheetFormatEscapeParserToken t) {
                assertSame(token, t);
                b.append("5");
            }
        }.accept(token);
    ...
    @Override
    public SpreadsheetFormatEscapeParserToken unmarshall(final JsonNode node,
