...
public final class SpreadsheetFormatUnderscoreParserTokenTest extends SpreadsheetFormatNonSymbolParserTokenTestCase<SpreadsheetFormatUnderscoreParserToken, Character> {

    @Test
    public void testAccept() {
        final StringBuilder b = new StringBuilder();
        final SpreadsheetFormatUnderscoreParserToken token = this.createToken();
        ...
        new FakeSpreadsheetFormatParserTokenVisitor() {
            ...
            @Override
            protected void visit(final SpreadsheetFormatUnderscoreParserToken t) {
                assertSame(token, t);
                b.append("5");
            }
        }.accept(token);
    ...
    @Override
    public SpreadsheetFormatUnderscoreParserToken unmarshall(final JsonNode node,
