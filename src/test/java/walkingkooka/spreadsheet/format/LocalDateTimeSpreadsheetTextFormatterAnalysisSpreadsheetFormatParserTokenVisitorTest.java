...
public final class LocalDateTimeSpreadsheetTextFormatterAnalysisSpreadsheetFormatParserTokenVisitorTest extends
        TextFormatterSpreadsheetFormatParserTokenVisitorTestCase<LocalDateTimeSpreadsheetTextFormatterAnalysisSpreadsheetFormatParserTokenVisitor> {
    ...
    private void acceptAndCheck(final String pattern,
                                ...
                                final boolean ampm) {
        final LocalDateTimeSpreadsheetTextFormatterAnalysisSpreadsheetFormatParserTokenVisitor visitor = LocalDateTimeSpreadsheetTextFormatterAnalysisSpreadsheetFormatParserTokenVisitor.with();
    ...
    public void testToString12h() {
        final LocalDateTimeSpreadsheetTextFormatterAnalysisSpreadsheetFormatParserTokenVisitor visitor = this.createVisitor();
        visitor.accept(SpreadsheetFormatParserToken.amPm("AMPM", "AMPM"));
        this.toStringAndCheck(visitor, "12h");
    }

    @Override
    public LocalDateTimeSpreadsheetTextFormatterAnalysisSpreadsheetFormatParserTokenVisitor createVisitor() {
        return new LocalDateTimeSpreadsheetTextFormatterAnalysisSpreadsheetFormatParserTokenVisitor();
    }
    ...
    @Override
    public Class<LocalDateTimeSpreadsheetTextFormatterAnalysisSpreadsheetFormatParserTokenVisitor> type() {
        return LocalDateTimeSpreadsheetTextFormatterAnalysisSpreadsheetFormatParserTokenVisitor.class;
    }
}
