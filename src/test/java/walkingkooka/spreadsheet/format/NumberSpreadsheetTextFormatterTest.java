...
public final class NumberSpreadsheetTextFormatterTest extends SpreadsheetTextFormatter3TestCase<NumberSpreadsheetTextFormatter,
    ...
    private void parseFormatAndCheck0(final String pattern,
        ...
        final NumberSpreadsheetTextFormatter formatter = this.createFormatter(pattern);
    ...
    @Override
    public Class<NumberSpreadsheetTextFormatter> type() {
        return NumberSpreadsheetTextFormatter.class;
    }
}
