...
public final class SpreadsheetFormatterSelectorTokenTest implements PluginSelectorTokenLikeTesting<SpreadsheetFormatterSelectorToken, SpreadsheetFormatterSelectorTokenAlternative> {
    @Override
    public SpreadsheetFormatterSelectorToken createPluginSelectorTokenLike(final String label,
                                                                           final String text,
    ...
    @Override
    public Class<SpreadsheetFormatterSelectorToken> type() {
        return SpreadsheetFormatterSelectorToken.class;
    }
}
