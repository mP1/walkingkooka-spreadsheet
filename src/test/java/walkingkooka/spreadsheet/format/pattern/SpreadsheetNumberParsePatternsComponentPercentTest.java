...
public final class SpreadsheetNumberParsePatternsComponentPercentTest extends SpreadsheetNumberParsePatternsComponentTestCase2<SpreadsheetNumberParsePatternsComponentPercent> {
    ...
    @Override
    SpreadsheetNumberParsePatternsComponentPercent createComponent() {
    ...
    @Override
    public Class<SpreadsheetNumberParsePatternsComponentPercent> type() {
        return SpreadsheetNumberParsePatternsComponentPercent.class;
    }
