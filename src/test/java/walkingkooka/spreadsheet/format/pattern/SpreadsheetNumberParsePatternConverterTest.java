...
public final class SpreadsheetNumberParsePatternConverterTest extends SpreadsheetNumberParsePatternTestCase2<SpreadsheetNumberParsePatternConverter>
        implements ConverterTesting2<SpreadsheetNumberParsePatternConverter, ExpressionNumberConverterContext> {
    ...
    @Override
    public SpreadsheetNumberParsePatternConverter createConverter() {
        return this.createConverter("#");
    }

    private SpreadsheetNumberParsePatternConverter createConverter(final String pattern) {
        return SpreadsheetNumberParsePattern.parseNumberParsePattern(pattern).createConverter();
    }
    ...
    @Override
    public Class<SpreadsheetNumberParsePatternConverter> type() {
        return SpreadsheetNumberParsePatternConverter.class;
    }
}
