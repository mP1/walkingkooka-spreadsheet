...
public final class SpreadsheetErrorKindTest implements ParseStringTesting<SpreadsheetErrorKind>,
    ...
    // "walkingkooka.spreadsheet.value.SpreadsheetErrorKindTest cannot be cast to java.base/java.lang.Void"
    @Test
    ...
    // class walkingkooka.spreadsheet.value.SpreadsheetError cannot be cast to class walkingkooka.tree.expression.ExpressionNumber
    // (walkingkooka.spreadsheet.value.SpreadsheetError and walkingkooka.tree.expression.ExpressionNumber are in unnamed module of loader 'app')

    @Test
    public void testTranslateClassCastExceptionClassClassNameCannotBeCastToClasClassName() {
        this.translateAndCheck(
            new ClassCastException("class walkingkooka.spreadsheet.value.SpreadsheetError cannot be cast to class walkingkooka.tree.expression.ExpressionNumber(walkingkooka.spreadsheet.value.SpreadsheetError and walkingkooka.tree.expression.ExpressionNumber are in unnamed module of loader 'app')"),
            SpreadsheetErrorKind.VALUE,
