...
public abstract class SpreadsheetSelectionTestCase<S extends SpreadsheetSelection> implements ClassTesting2<S>,
    ...
    final void moveRightColumnAndCheck(final String selection,
                                       final SpreadsheetViewportAnchor anchor,
                                       final String hiddenColumns,
                                       final String hiddenRows,
                                       final String expected) {
    ...
    final void moveRightColumnAndCheck(final S selection,
                                       final SpreadsheetViewportAnchor anchor,
                                       final Predicate<SpreadsheetColumnReference> hiddenColumns,
                                       final Predicate<SpreadsheetRowReference> hiddenRows,
                                       final Optional<SpreadsheetSelection> expected) {
    ...
    final void moveRightPixelsAndCheck(final String selection,
                                       final SpreadsheetViewportAnchor anchor,
                                       final int count,
                                       final String hiddenColumns,
                                       final Map<String, Double> columnWidths,
    ...
    final void moveRightPixelsAndCheck(final S selection,
                                       final SpreadsheetViewportAnchor anchor,
                                       final int count,
                                       final Predicate<SpreadsheetColumnReference> hiddenColumns,
                                       final Function<SpreadsheetColumnReference, Double> columnWidths,
    ...
    final void moveDownPixelsAndCheck(final String selection,
                                      final SpreadsheetViewportAnchor anchor,
                                      final int count,
                                      final String hiddenColumns,
                                      final Map<String, Double> columnWidths,
    ...
    final void moveDownPixelsAndCheck(final S selection,
                                      final SpreadsheetViewportAnchor anchor,
                                      final int count,
                                      final Predicate<SpreadsheetColumnReference> hiddenColumns,
                                      final Function<SpreadsheetColumnReference, Double> columnWidths,
