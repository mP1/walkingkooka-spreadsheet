...
public final class SpreadsheetRowRangeReferenceTest extends SpreadsheetColumnOrRowRangeReferenceTestCase<SpreadsheetRowRangeReference, SpreadsheetRowReference>
    ...
    @Test
    public void testSetFarthestRowWithNullFails() {
        assertThrows(
                NullPointerException.class,
                () -> this.createSelection().setFarthestRow(null)
        );
    }

    @Test
    public void testSetFarthestRowUnitSame() {
        this.setFarthestRowAndCheck(
                "2",
                "2",
                SpreadsheetSelection.parseRowRange("2")
                        .setDefaultAnchor()
    ...
    @Test
    public void testSetFarthestRowLeft() {
        this.setFarthestRowAndCheck(
                "3:4",
                "3",
    ...
    @Test
    public void testSetFarthestRowLeft2() {
        this.setFarthestRowAndCheck(
                "3:4",
                "2",
    ...
    @Test
    public void testSetFarthestRowRight() {
        this.setFarthestRowAndCheck(
                "3:4",
                "4",
                SpreadsheetSelection.parseRowRange("3:4")
    ...
    @Test
    public void testSetFarthestRowRight2() {
        this.setFarthestRowAndCheck(
                "3:4",
                "5",
                SpreadsheetSelection.parseRowRange("3:5")
    ...
    private void setFarthestRowAndCheck(final String range,
                                        final String row,
    ...
    private void setFarthestRowAndCheck(final SpreadsheetRowRangeReference range,
                                        final SpreadsheetRowReference row,
                                        final AnchoredSpreadsheetSelection anchoredSpreadsheetSelection) {
        this.checkEquals(
                anchoredSpreadsheetSelection,
                range.setFarthestRow(row),
                () -> range + " setFarthestRow " + row
        );
    }
