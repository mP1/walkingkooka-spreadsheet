...
public final class SpreadsheetCellRangeReferenceTest extends SpreadsheetCellReferenceOrRangeTestCase<SpreadsheetCellRangeReference>
    ...
    @Test
    public void testComparatorNamesCheckWithNullComparatorsFails() {
        assertThrows(
                NullPointerException.class,
    ...
    @Test
    public void testComparatorNamesCheckWitEmptyComparatorsFails() {
        assertThrows(
                IllegalArgumentException.class,
                () -> this.createSelection()
                        .comparatorNamesCheck(Lists.empty())
        );
    }
