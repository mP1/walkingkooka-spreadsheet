...
public final class SpreadsheetCellToConverterTest implements ConverterTesting2<SpreadsheetCellToConverter, SpreadsheetConverterContext>,
        ToStringTesting<SpreadsheetCellToConverter> {
    ...
    @Override
    public SpreadsheetCellToConverter createConverter() {
    ...
    @Override
    public Class<SpreadsheetCellToConverter> type() {
        return SpreadsheetCellToConverter.class;
    }
}
