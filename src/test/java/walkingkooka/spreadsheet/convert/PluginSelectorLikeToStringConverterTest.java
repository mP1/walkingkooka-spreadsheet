...
public final class PluginSelectorLikeToStringConverterTest implements ConverterTesting2<PluginSelectorLikeToStringConverter,
    ...
    @Override
    public PluginSelectorLikeToStringConverter createConverter() {
    ...
    public void testToString() {
        this.toStringAndCheck(
                PluginSelectorLikeToStringConverter.INSTANCE,
    ...
    @Override
    public Class<PluginSelectorLikeToStringConverter> type() {
        return PluginSelectorLikeToStringConverter.class;
    }
}
