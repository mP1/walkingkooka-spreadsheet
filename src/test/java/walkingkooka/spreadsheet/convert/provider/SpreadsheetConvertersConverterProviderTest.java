...
public class SpreadsheetConvertersConverterProviderTest implements ConverterProviderTesting<SpreadsheetConvertersConverterProvider>,
    ...
    public void testConverterSelectorWithStoragePathPropertiesToClass() {
        this.converterAndCheck(
            ...
            PROVIDER_CONTEXT,
            SpreadsheetConverters.storagePathPropertiesToClass()
        );
    }

    @Test
    public void testConverterSelectorWithStoragePathTxtToClass() {
        this.converterAndCheck(
            "storage-path-txt-to-class",
            PROVIDER_CONTEXT,
            SpreadsheetConverters.storagePathTxtToClass()
        );
    }
