...
public final class AdditionSpreadsheetParserTokenTest extends ArithmeticSpreadsheetParserTokenTestCase<AdditionSpreadsheetParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final AdditionSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final AdditionSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    AdditionSpreadsheetParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<AdditionSpreadsheetParserToken> type() {
        return AdditionSpreadsheetParserToken.class;
    }

    @Override
    public AdditionSpreadsheetParserToken unmarshall(final JsonNode from,
                                                     final JsonNodeUnmarshallContext context) {
        return SpreadsheetParserToken.unmarshallAddition(from, context);
    }
}
