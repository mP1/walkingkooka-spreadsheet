...
public final class NotEqualsSpreadsheetParserTokenTest extends ConditionSpreadsheetParserTokenTestCase<NotEqualsSpreadsheetParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final NotEqualsSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final NotEqualsSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
            ...
            @Override
            protected void visit(final NotEqualsSymbolSpreadsheetParserToken t) {
                b.append("7");
                visited.add(t);
            }
    ...
    @Override
    NotEqualsSpreadsheetParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<NotEqualsSpreadsheetParserToken> type() {
        return NotEqualsSpreadsheetParserToken.class;
    }

    @Override
    public NotEqualsSpreadsheetParserToken unmarshall(final JsonNode from,
                                                      final JsonNodeUnmarshallContext context) {
        return SpreadsheetParserToken.unmarshallNotEquals(from, context);
    }
}
