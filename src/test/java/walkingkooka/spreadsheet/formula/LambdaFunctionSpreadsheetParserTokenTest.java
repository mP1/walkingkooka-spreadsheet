...
public final class LambdaFunctionSpreadsheetParserTokenTest extends FunctionSpreadsheetParserTokenTestCase<LambdaFunctionSpreadsheetParserToken> {
    ...
    public void testWith() {
        final String text = FUNCTION + "(" + PARAMETER + ")(" + ParentSpreadsheetParserTokenTestCase.NUMBER1 + ")";
        final FunctionNameSpreadsheetParserToken name = this.functionNameParserToken();
        final LambdaFunctionSpreadsheetParserToken token = this.createToken(
                text,
                name,
    ...
    public void testWithSymbols() {
        ...
        final FunctionParametersSpreadsheetParserToken parameterValues = this.functionParameters(
                this.openParenthesisSymbol(),
                this.number1(),
                this.closeParenthesisSymbol()
        );
    ...
    public void testToExpression() {
        this.toExpressionAndCheck(
                Expression.call(
                        ...
                        Lists.of(
                                Expression.value(
                                        this.expressionNumber(ParentSpreadsheetParserTokenTestCase.NUMBER1)
                                )
                        )
                )
        );
    ...
    private void checkFunctionName(final LambdaFunctionSpreadsheetParserToken function,
    ...
    private void checkParameters(final LambdaFunctionSpreadsheetParserToken function,
    ...
    private void checkParameterValues(final LambdaFunctionSpreadsheetParserToken function,
                                      final FunctionParametersSpreadsheetParserToken parameterValues) {
        this.checkEquals(
                parameterValues,
    ...
    @Override
    LambdaFunctionSpreadsheetParserToken createToken(final String text,
    ...
    @Override
    public String text() {
        return FUNCTION + "(" + ParentSpreadsheetParserTokenTestCase.NUMBER1 + ")";
    }
    ...
    @Override
    public LambdaFunctionSpreadsheetParserToken createDifferentToken() {
    ...
    @Override
    public Class<LambdaFunctionSpreadsheetParserToken> type() {
        return LambdaFunctionSpreadsheetParserToken.class;
    }

    @Override
    public LambdaFunctionSpreadsheetParserToken unmarshall(final JsonNode from,
