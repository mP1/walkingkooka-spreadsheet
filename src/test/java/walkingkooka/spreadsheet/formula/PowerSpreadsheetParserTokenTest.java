...
public final class PowerSpreadsheetParserTokenTest extends ArithmeticSpreadsheetParserTokenTestCase<PowerSpreadsheetParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final PowerSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final PowerSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    PowerSpreadsheetParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<PowerSpreadsheetParserToken> type() {
        return PowerSpreadsheetParserToken.class;
    }

    @Override
    public PowerSpreadsheetParserToken unmarshall(final JsonNode from,
                                                  final JsonNodeUnmarshallContext context) {
        return SpreadsheetParserToken.unmarshallPower(from, context);
    }
}
