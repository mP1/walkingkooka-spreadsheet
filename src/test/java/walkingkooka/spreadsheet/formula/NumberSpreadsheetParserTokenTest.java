...
public final class NumberSpreadsheetParserTokenTest extends ValueSpreadsheetParserTokenTestCase<NumberSpreadsheetParserToken> {
    ...
    private static DigitsSpreadsheetParserToken digit(final String text) {
        return DigitsSpreadsheetParserToken.digits(text, text);
    }

    private static ExponentSymbolSpreadsheetParserToken exponent() {
        return DigitsSpreadsheetParserToken.exponentSymbol("E", "E");
    }

    private static MinusSymbolSpreadsheetParserToken minus() {
        return DigitsSpreadsheetParserToken.minusSymbol("-", "-");
    }

    private static PercentSymbolSpreadsheetParserToken percent() {
        return DigitsSpreadsheetParserToken.percentSymbol("%", "%");
    }

    private static PlusSymbolSpreadsheetParserToken plus() {
        return DigitsSpreadsheetParserToken.plusSymbol("+", "+");
    }
    ...
    private void toExpressionAndCheck2(final Double expected,
        ...
        final NumberSpreadsheetParserToken numberParserToken = NumberSpreadsheetParserToken.with(
                tokensList,
    ...
    private void toExpressionAndCheck2(final NumberSpreadsheetParserToken token,
    ...
    @Override
    NumberSpreadsheetParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public NumberSpreadsheetParserToken createDifferentToken() {
    ...
    @Override
    public Class<NumberSpreadsheetParserToken> type() {
        return NumberSpreadsheetParserToken.class;
    }

    @Override
    public NumberSpreadsheetParserToken unmarshall(final JsonNode from,
