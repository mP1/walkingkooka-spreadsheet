...
public final class NotEqualsSpreadsheetFormulaParserTokenTest extends ConditionSpreadsheetFormulaParserTokenTestCase<NotEqualsSpreadsheetFormulaParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetFormulaParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final NotEqualsSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final NotEqualsSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
            ...
            @Override
            protected void visit(final NotEqualsSymbolSpreadsheetFormulaParserToken t) {
                b.append("7");
                visited.add(t);
            }
    ...
    @Override
    NotEqualsSpreadsheetFormulaParserToken createToken(final String text, final List<ParserToken> tokens) {
        return SpreadsheetFormulaParserToken.notEquals(tokens, text);
    }
    ...
    Expression expressionNode(final Expression left, final Expression right) {
        return Expression.notEquals(left, right);
    }

    @Override
    public Class<NotEqualsSpreadsheetFormulaParserToken> type() {
        return NotEqualsSpreadsheetFormulaParserToken.class;
    }

    @Override
    public NotEqualsSpreadsheetFormulaParserToken unmarshall(final JsonNode from,
                                                             final JsonNodeUnmarshallContext context) {
        return SpreadsheetFormulaParserToken.unmarshallNotEquals(from, context);
    }
}
