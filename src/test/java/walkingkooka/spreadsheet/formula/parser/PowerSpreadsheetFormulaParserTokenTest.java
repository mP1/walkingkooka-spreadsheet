...
public final class PowerSpreadsheetFormulaParserTokenTest extends ArithmeticSpreadsheetFormulaParserTokenTestCase<PowerSpreadsheetFormulaParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetFormulaParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final PowerSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final PowerSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
            ...
            @Override
            protected void visit(final PowerSymbolSpreadsheetFormulaParserToken t) {
                b.append("7");
                visited.add(t);
            }
    ...
    @Override
    PowerSpreadsheetFormulaParserToken createToken(final String text, final List<ParserToken> tokens) {
        return SpreadsheetFormulaParserToken.power(tokens, text);
    }
    ...
    @Override
    public Class<PowerSpreadsheetFormulaParserToken> type() {
        return PowerSpreadsheetFormulaParserToken.class;
    }

    @Override
    public PowerSpreadsheetFormulaParserToken unmarshall(final JsonNode from,
                                                         final JsonNodeUnmarshallContext context) {
        return SpreadsheetFormulaParserToken.unmarshallPower(from, context);
    }
}
