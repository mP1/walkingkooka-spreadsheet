...
public final class GreaterThanEqualsSpreadsheetFormulaParserTokenTest extends ConditionSpreadsheetFormulaParserTokenTestCase<GreaterThanEqualsSpreadsheetFormulaParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetFormulaParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final GreaterThanEqualsSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final GreaterThanEqualsSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
            ...
            @Override
            protected void visit(final GreaterThanEqualsSymbolSpreadsheetFormulaParserToken t) {
                b.append("7");
                visited.add(t);
            }
    ...
    @Override
    GreaterThanEqualsSpreadsheetFormulaParserToken createToken(final String text, final List<ParserToken> tokens) {
        return SpreadsheetFormulaParserToken.greaterThanEquals(tokens, text);
    }
    ...
    Expression expressionNode(final Expression left, final Expression right) {
        return Expression.greaterThanEquals(left, right);
    }

    @Override
    public Class<GreaterThanEqualsSpreadsheetFormulaParserToken> type() {
        return GreaterThanEqualsSpreadsheetFormulaParserToken.class;
    }

    @Override
    public GreaterThanEqualsSpreadsheetFormulaParserToken unmarshall(final JsonNode from,
                                                                     final JsonNodeUnmarshallContext context) {
        return SpreadsheetFormulaParserToken.unmarshallGreaterThanEquals(from, context);
    }
}
