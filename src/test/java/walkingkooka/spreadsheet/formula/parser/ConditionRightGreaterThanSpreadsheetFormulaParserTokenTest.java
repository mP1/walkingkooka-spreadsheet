...
public final class ConditionRightGreaterThanSpreadsheetFormulaParserTokenTest extends ConditionRightSpreadsheetFormulaParserTokenTestCase<ConditionRightGreaterThanSpreadsheetFormulaParserToken> {

    @Test
    public void testSetConditionLeft() {
        final ConditionRightGreaterThanSpreadsheetFormulaParserToken token = this.createToken();
    ...
    @Override
    public Class<ConditionRightGreaterThanSpreadsheetFormulaParserToken> type() {
        return ConditionRightGreaterThanSpreadsheetFormulaParserToken.class;
    }
}
