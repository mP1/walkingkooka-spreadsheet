...
public final class LessThanSpreadsheetFormulaParserTokenTest extends ConditionSpreadsheetFormulaParserTokenTestCase<LessThanSpreadsheetFormulaParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetFormulaParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final LessThanSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final LessThanSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
            ...
            @Override
            protected void visit(final LessThanSymbolSpreadsheetFormulaParserToken t) {
                b.append("7");
                visited.add(t);
            }
    ...
    @Override
    LessThanSpreadsheetFormulaParserToken createToken(final String text, final List<ParserToken> tokens) {
        return SpreadsheetFormulaParserToken.lessThan(tokens, text);
    }
    ...
    @Override
    public Class<LessThanSpreadsheetFormulaParserToken> type() {
        return LessThanSpreadsheetFormulaParserToken.class;
    }

    @Override
    public LessThanSpreadsheetFormulaParserToken unmarshall(final JsonNode from,
                                                            final JsonNodeUnmarshallContext context) {
        return SpreadsheetFormulaParserToken.unmarshallLessThan(from, context);
    }
}
