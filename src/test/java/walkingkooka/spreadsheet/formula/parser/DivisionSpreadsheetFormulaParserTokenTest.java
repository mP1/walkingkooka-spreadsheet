...
public final class DivisionSpreadsheetFormulaParserTokenTest extends ArithmeticSpreadsheetFormulaParserTokenTestCase<DivisionSpreadsheetFormulaParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetFormulaParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final DivisionSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final DivisionSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
            ...
            @Override
            protected void visit(final DivideSymbolSpreadsheetFormulaParserToken t) {
                b.append("7");
                visited.add(t);
            }
    ...
    @Override
    DivisionSpreadsheetFormulaParserToken createToken(final String text, final List<ParserToken> tokens) {
        return SpreadsheetFormulaParserToken.division(tokens, text);
    }
    ...
    @Override
    public Class<DivisionSpreadsheetFormulaParserToken> type() {
        return DivisionSpreadsheetFormulaParserToken.class;
    }

    @Override
    public DivisionSpreadsheetFormulaParserToken unmarshall(final JsonNode from,
                                                            final JsonNodeUnmarshallContext context) {
        return SpreadsheetFormulaParserToken.unmarshallDivision(from, context);
    }
}
