...
public final class ConditionRightNotEqualsSpreadsheetFormulaParserTokenTest extends ConditionRightSpreadsheetFormulaParserTokenTestCase<ConditionRightNotEqualsSpreadsheetFormulaParserToken> {

    @Test
    public void testSetConditionLeft() {
        final ConditionRightNotEqualsSpreadsheetFormulaParserToken token = this.createToken();
    ...
    @Override
    public Class<ConditionRightNotEqualsSpreadsheetFormulaParserToken> type() {
        return ConditionRightNotEqualsSpreadsheetFormulaParserToken.class;
    }
}
