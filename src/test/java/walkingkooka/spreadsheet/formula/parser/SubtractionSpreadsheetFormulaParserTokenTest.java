...
public final class SubtractionSpreadsheetFormulaParserTokenTest extends ArithmeticSpreadsheetFormulaParserTokenTestCase<SubtractionSpreadsheetFormulaParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetFormulaParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final SubtractionSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final SubtractionSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
    ...
    @Override
    SubtractionSpreadsheetFormulaParserToken createToken(final String text, final List<ParserToken> tokens) {
        return SpreadsheetFormulaParserToken.subtraction(tokens, text);
    }
    ...
    @Override
    public Class<SubtractionSpreadsheetFormulaParserToken> type() {
        return SubtractionSpreadsheetFormulaParserToken.class;
    }

    @Override
    public SubtractionSpreadsheetFormulaParserToken unmarshall(final JsonNode from,
                                                               final JsonNodeUnmarshallContext context) {
        return SpreadsheetFormulaParserToken.unmarshallSubtraction(from, context);
    }
}
