...
public final class LessThanEqualsSpreadsheetFormulaParserTokenTest extends ConditionSpreadsheetFormulaParserTokenTestCase<LessThanEqualsSpreadsheetFormulaParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetFormulaParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final LessThanEqualsSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final LessThanEqualsSpreadsheetFormulaParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
            ...
            @Override
            protected void visit(final LessThanEqualsSymbolSpreadsheetFormulaParserToken t) {
                b.append("7");
                visited.add(t);
            }
    ...
    @Override
    LessThanEqualsSpreadsheetFormulaParserToken createToken(final String text, final List<ParserToken> tokens) {
        return SpreadsheetFormulaParserToken.lessThanEquals(tokens, text);
    }
    ...
    Expression expressionNode(final Expression left, final Expression right) {
        return Expression.lessThanEquals(left, right);
    }

    @Override
    public Class<LessThanEqualsSpreadsheetFormulaParserToken> type() {
        return LessThanEqualsSpreadsheetFormulaParserToken.class;
    }

    @Override
    public LessThanEqualsSpreadsheetFormulaParserToken unmarshall(final JsonNode from,
                                                                  final JsonNodeUnmarshallContext context) {
        return SpreadsheetFormulaParserToken.unmarshallLessThanEquals(from, context);
    }
}
