...
public final class TimeSpreadsheetParserTokenTest extends ValueSpreadsheetParserTokenTestCase<TimeSpreadsheetParserToken> {
    ...
    public void testToExpressionHourMinuteSeconds() {
        this.toExpressionAndCheck2(
                LocalTime.of(ParentSpreadsheetParserTokenTestCase.HOUR, ParentSpreadsheetParserTokenTestCase.MINUTE, ParentSpreadsheetParserTokenTestCase.SECONDS),
                hour(),
                colonTextLiteral(),
                minute(),
                colonTextLiteral(),
    ...
    public void testToExpressionHourMinute() {
        this.toExpressionAndCheck2(
                LocalTime.of(ParentSpreadsheetParserTokenTestCase.HOUR, ParentSpreadsheetParserTokenTestCase.MINUTE, 0),
                hour(),
                colonTextLiteral(),
                minute()
        );
    ...
    public void testToExpressionHourMinutePm() {
        this.toExpressionAndCheck2(
                LocalTime.of(23, ParentSpreadsheetParserTokenTestCase.MINUTE, 0),
    ...
    public void testToExpressionHourSeconds() {
        this.toExpressionAndCheck2(
                LocalTime.of(ParentSpreadsheetParserTokenTestCase.HOUR, 0, ParentSpreadsheetParserTokenTestCase.SECONDS),
                hour(),
                colonTextLiteral(),
                seconds()
        );
    ...
    public void testToExpressionHourSecondsMillis() {
        this.toExpressionAndCheck2(
                LocalTime.of(ParentSpreadsheetParserTokenTestCase.HOUR, 0, ParentSpreadsheetParserTokenTestCase.SECONDS, ParentSpreadsheetParserTokenTestCase.MILLISECOND),
                hour(),
                colonTextLiteral(),
                seconds(),
                decimalSeparator(),
    ...
    @Override
    public String text() {
        return "" + ParentSpreadsheetParserTokenTestCase.HOUR + ":" + ParentSpreadsheetParserTokenTestCase.MINUTE + ":" + ParentSpreadsheetParserTokenTestCase.SECONDS + "." + ParentSpreadsheetParserTokenTestCase.MILLISECOND;
    }
    ...
    private LocalTime time() {
        return LocalTime.of(ParentSpreadsheetParserTokenTestCase.HOUR, ParentSpreadsheetParserTokenTestCase.MINUTE, ParentSpreadsheetParserTokenTestCase.SECONDS, ParentSpreadsheetParserTokenTestCase.MILLISECOND);
    }

    @Override
    public TimeSpreadsheetParserToken createDifferentToken() {
        final String different = "" + ParentSpreadsheetParserTokenTestCase.SECONDS + ":" + ParentSpreadsheetParserTokenTestCase.MINUTE + ":" + ParentSpreadsheetParserTokenTestCase.HOUR;
