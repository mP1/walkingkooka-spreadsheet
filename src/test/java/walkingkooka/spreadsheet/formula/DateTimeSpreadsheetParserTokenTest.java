...
public final class DateTimeSpreadsheetParserTokenTest extends ValueSpreadsheetParserTokenTestCase<DateTimeSpreadsheetParserToken> {
    ...
    private void toExpressionAndCheck2(final ExpressionEvaluationContext context,
        ...
        final DateTimeSpreadsheetParserToken dateTimeParserToken = DateTimeSpreadsheetParserToken.with(
                tokensList,
    ...
    @Override
    DateTimeSpreadsheetParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public DateTimeSpreadsheetParserToken createDifferentToken() {
    ...
    @Override
    public Class<DateTimeSpreadsheetParserToken> type() {
        return DateTimeSpreadsheetParserToken.class;
    }

    @Override
    public DateTimeSpreadsheetParserToken unmarshall(final JsonNode from,
