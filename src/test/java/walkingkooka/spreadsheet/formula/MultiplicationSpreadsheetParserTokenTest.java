...
public final class MultiplicationSpreadsheetParserTokenTest extends ArithmeticSpreadsheetParserTokenTestCase<MultiplicationSpreadsheetParserToken> {
    ...
    public void testAccept() {
        ...
        new FakeSpreadsheetParserTokenVisitor() {
            ...
            @Override
            protected Visiting startVisit(final MultiplicationSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("3");
                visited.add(t);
                return Visiting.CONTINUE;
            ...
            @Override
            protected void endVisit(final MultiplicationSpreadsheetParserToken t) {
                assertSame(binary, t);
                b.append("4");
                visited.add(t);
            }
            ...
            @Override
            protected void visit(final MultiplySymbolSpreadsheetParserToken t) {
                b.append("7");
                visited.add(t);
            }
    ...
    @Override
    MultiplicationSpreadsheetParserToken createToken(final String text, final List<ParserToken> tokens) {
    ...
    @Override
    public Class<MultiplicationSpreadsheetParserToken> type() {
        return MultiplicationSpreadsheetParserToken.class;
    }

    @Override
    public MultiplicationSpreadsheetParserToken unmarshall(final JsonNode from,
                                                           final JsonNodeUnmarshallContext context) {
        return SpreadsheetParserToken.unmarshallMultiplication(from, context);
    }
}
