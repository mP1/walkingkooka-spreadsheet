...
public final class SpreadsheetFormattedCellTest implements ClassTesting2<SpreadsheetFormattedCell>,
        HashCodeEqualsDefinedTesting<SpreadsheetFormattedCell>,
    ...
    @Override
    public SpreadsheetFormattedCell createHasJsonNode() {
