...
import walkingkooka.spreadsheet.format.provider.FakeSpreadsheetFormatterProvider;
...
public final class SpreadsheetEngineBasicTest extends SpreadsheetEngineBasicTestCase<SpreadsheetEngineBasic>
    ...
    private final static class TestSpreadsheetContext implements SpreadsheetContext,
        ...
        public Charset charset() {
            return SpreadsheetEngineBasicTest.CHARSET;
        }
    ...
    public void testEvaluateCellReferenceWithSpreadsheetContext() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
    ...
    @Test
    public void testSaveCellStyleReformats() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testSaveCellFormulaRefreshesReference1() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testSaveCellFormulaRefreshesReference2() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testSaveCellFormulaRefreshesReference3() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testSaveCellFormulaRefreshesMissingReferences() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testSaveCellFormulaWithLabel() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testSaveCellRefreshesLabelReference() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testSaveCellFormulaRefreshesMultipleCells() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testSaveCellFormulaDifferentReferences() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testSaveCellAndLoad() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
                ...
                .setCells(
                    Sets.of(
                        SpreadsheetSelection.A1.setFormula(
                                a1Formula.setError(
                                    Optional.of(
                                        SpreadsheetErrorKind.VALIDATION.setMessage("Validator throws 123")
                                    )
                                )
                            ).setValidator(
                                Optional.of(validatorSelector)
        ...
        SpreadsheetCell a1FormattedCell = a1Cell.setFormula(
            a1Cell.formula()
                .setValue(
                    ...
                    SpreadsheetError.validationErrors(validationErrorsFail)
                )
        ).setFormattedValue(
            Optional.of(
                TextNode.text("#ERROR " + FORMATTED_PATTERN_SUFFIX)
        ...
        a1FormattedCell = a1Cell.setFormula(
            a1Cell.formula()
                .setValue(
                    ...
                    SpreadsheetError.validationErrors(validationErrorsPass)
                )
        ).setFormattedValue(
            Optional.of(
                TextNode.text(value + " " + FORMATTED_PATTERN_SUFFIX)
    ...
    @Test
    public void testSaveCellDateTimeSymbolsReformats() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        ...
        a1FormattedCell = a1Cell.setFormattedValue(
            Optional.of(
                STYLE.setChildren(
                    Lists.of(
                        TextNode.text("Fri./December/1999") // <--- refreshed
                    )
                )
            )
        );
    ...
    @Test
    public void testSaveCellFormatterUnknown() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        ...
        final SpreadsheetFormatterSelector formatter = SpreadsheetFormatterSelector.parse("unknown-formatter");
            ...
            a1Formula.setError(
                Optional.of(
                    SpreadsheetErrorKind.FORMATTING.setMessageAndValue(
                        "Unknown formatter unknown-formatter",
                        formatter
                    )
                )
            )
    ...
    @Test
    public void testSaveCellFormatterThrows() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        ...
        final SpreadsheetFormatterSelector formatterSelector = SpreadsheetFormatterSelector.parse("throwing-formatter");
        ...
        final SpreadsheetMetadata metadata = METADATA.set(
            ...
            SpreadsheetFormatterAliasSet.parse(formatterSelector.valueText())
        );
                ...
                SpreadsheetProviders.basic(
                    ...
                    new FakeSpreadsheetFormatterProvider() {
                        ...
                        public SpreadsheetFormatter spreadsheetFormatter(final SpreadsheetFormatterSelector selector,
                                                                         final ProviderContext context) {
                            if (formatterSelector.equals(selector)) {
                                return new FakeSpreadsheetFormatter() {

                                    @Override
                                    public Optional<TextNode> format(final Optional<Object> value,
                                                                     final SpreadsheetFormatterContext context) {
                                        throw new RuntimeException("Formatter throws 123");
                                    }
                                };
                            }
                            return SPREADSHEET_FORMATTER_PROVIDER.spreadsheetFormatter(selector, context);
                        }
                    },
                    FormHandlerProviders.fake(),
                    SPREADSHEET_IMPORTER_PROVIDER,
    ...
    @Test
    public void testSaveCellAfterSaveCellAndSaveLabel() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testSaveCellAndColumns() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithDeleteOneCell() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithDeleteOneCell2() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithDeletesManyCells() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithDeletesManyCells2() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithSaveWithMissingCells() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithSaveWithMissingCells2() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithRangeOneEmptyCells2() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithRangeTwoEmptyCells() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithAddition() {
        this.fillCellsAndCheck(
            "=1+0",
            1 + 0
        );
    ...
    @Test
    public void testFillCellsWithExpressionNumber() {
        this.fillCellsAndCheck(
            "=99.5",
            99.5
        );
    ...
    @Test
    public void testFillCellsWithExpressionNumber2() {
        this.fillCellsAndCheck(
            "=99",
            99
        );
    ...
    @Test
    public void testFillCellsWithDivision() {
        this.fillCellsAndCheck(
            "=10/5",
            10 / 5
        );
    ...
    @Test
    public void testFillCellsWithEqualsTrue() {
        this.fillCellsAndCheck(
            "=10=10",
            true
        );
    ...
    @Test
    public void testFillCellsWithEqualsFalse() {
        this.fillCellsAndCheck(
            "=10=9",
            false
        );
    ...
    @Test
    public void testFillCellsWithGreaterThanTrue() {
        this.fillCellsAndCheck(
            "=10>9",
            true
        );
    ...
    @Test
    public void testFillCellsWithGreaterThanFalse() {
        this.fillCellsAndCheck(
            "=10>11",
            false
        );
    ...
    @Test
    public void testFillCellsWithGreaterThanEqualsTrue() {
        this.fillCellsAndCheck(
            "=10>=10",
            true
        );
    ...
    @Test
    public void testFillCellsWithGreaterThanEqualsFalse() {
        this.fillCellsAndCheck(
            "=10>=11",
            false
        );
    ...
    @Test
    public void testFillCellsWithFunction() {
        this.fillCellsAndCheck(
            "=BasicSpreadsheetEngineTestSum(1,99)",
            1 + 99
        );
    ...
    @Test
    public void testFillCellsWithGroup() {
        this.fillCellsAndCheck(
            "=(99)",
            99
        );
    ...
    @Test
    public void testFillCellsWithLessThanTrue() {
        this.fillCellsAndCheck(
            "=10<11",
            true
        );
    ...
    @Test
    public void testFillCellsWithLessThanFalse() {
        this.fillCellsAndCheck(
            "=10<9",
            false
        );
    ...
    @Test
    public void testFillCellsWithLessThanEqualsTrue() {
        this.fillCellsAndCheck(
            "=10<=10",
            true
        );
    ...
    @Test
    public void testFillCellsWithLessThanEqualsFalse() {
        this.fillCellsAndCheck(
            "=10<=9",
            false
        );
    ...
    @Test
    public void testFillCellsWithMultiplication() {
        this.fillCellsAndCheck(
            "=6*7",
            6 * 7
        );
    ...
    @Test
    public void testFillCellsWithNegative() {
        this.fillCellsAndCheck(
            "=-123",
            -123
        );
    ...
    @Test
    public void testFillCellsWithNotEqualsTrue() {
        this.fillCellsAndCheck(
            "=10<>9",
            true
        );
    ...
    @Test
    public void testFillCellsWithNotEqualsFalse() {
        this.fillCellsAndCheck(
            "=10<>10",
            false
        );
    ...
    @Test
    public void testFillCellsWithPercentage() {
        this.fillCellsAndCheck(
            "=123.5%",
            123.5 / 100
        );
    ...
    @Test
    public void testFillCellsWithSubtraction() {
        this.fillCellsAndCheck(
            "=13-4",
            13 - 4
        );
    ...
    @Test
    public void testFillCellsWithText() {
        this.fillCellsAndCheck(
            "=\"abc123\"",
            "abc123"
        );
    ...
    @Test
    public void testFillCellsWithAdditionWithWhitespace() {
        this.fillCellsAndCheck(
            "=1 + 2",
            1 + 2
        );
    ...
    @Test
    public void testFillCellsWithRepeatCellInto2x2() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWith2x2CellInto1x1() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWith2x2Into2x2() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWith2x2Into7x2Gives6x2() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWith2x2Into2x7Gives2x6() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithAbsoluteCellReference() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithExpressionRelativeCellReferenceFixed() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithExternalCellReferencesRefreshed() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithWithColumns() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testFillCellsWithWithRows() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
                ...
                .sortCells(
                    ...
                    new FakeSpreadsheetEngineContext() {
                        ...
                        public Indentation indentation() {
                            return SpreadsheetEngineBasicTest.INDENTATION;
                        }

                        @Override
                        public LineEnding lineEnding() {
                            return SpreadsheetEngineBasicTest.LINE_ENDING;
                        }

                        @Override
                        public Locale locale() {
                            return SpreadsheetEngineBasicTest.LOCALE;
                        }
                    }
                )
        );
    ...
    @Test
    public void testSaveLabelWithMissingLabelTwice() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testSaveLabelMissingRefreshesCell() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testSaveLabelRefreshesCell2() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Test
    public void testSaveLabelRefreshesCell3() {
        final SpreadsheetEngineBasic engine = this.createSpreadsheetEngine();
        final SpreadsheetEngineContext context = this.createContext();
    ...
    @Override
    public SpreadsheetEngineBasic createSpreadsheetEngine() {
    ...
    @Override
    public Class<SpreadsheetEngineBasic> type() {
        return SpreadsheetEngineBasic.class;
    }
