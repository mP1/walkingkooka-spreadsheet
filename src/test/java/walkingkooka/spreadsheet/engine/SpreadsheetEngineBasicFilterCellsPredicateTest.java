...
public final class SpreadsheetEngineBasicFilterCellsPredicateTest implements PredicateTesting2<SpreadsheetEngineBasicFilterCellsPredicate, SpreadsheetCell>,
    ...
    @Override
    public SpreadsheetEngineBasicFilterCellsPredicate createPredicate() {
        return this.createPredicate(
            SpreadsheetValueType.ANY
        );
    }

    private SpreadsheetEngineBasicFilterCellsPredicate createPredicate(final ValueType valueType) {
        ...
        return SpreadsheetEngineBasicFilterCellsPredicate.with(
            valueType,
            expression,
    ...
    @Override
    public Class<SpreadsheetEngineBasicFilterCellsPredicate> type() {
        return SpreadsheetEngineBasicFilterCellsPredicate.class;
    }
}
