...
public final class SpreadsheetCellReferenceToCurrencyMapTest implements MapTesting2<SpreadsheetCellReferenceToCurrencyMap, SpreadsheetCellReference, Optional<Currency>>,
    ...
    private final static Optional<Currency> VALUE2 = Optional.empty();

    private final static Map<SpreadsheetCellReference, Optional<Currency>> MAP = Maps.of(
        KEY1,
        VALUE1,
        KEY2,
        VALUE2
    ...
    public void testWithNullMapFails() {
        assertThrows(
            ...
            () -> SpreadsheetCellReferenceToCurrencyMap.with(null)
        );
    }

    @Test
    public void testWithIncludesNullSpreadsheetCellFails() {
        final Map<SpreadsheetCellReference, Optional<Currency>> map = SpreadsheetSelectionMaps.cell();
        map.put(KEY1, VALUE1);
        map.put(KEY2, null);
    ...
    @Test
    public void testWithSpreadsheetCellReferenceToCurrencyMapDoesntWrap() {
        final SpreadsheetCellReferenceToCurrencyMap map = this.createMap();
    ...
    public void testIteratorRemoveFails() {
        final Iterator<Map.Entry<SpreadsheetCellReference, Optional<Currency>>> iterator = this.createMap()
            .entrySet()
            .iterator();
        iterator.next();
    ...
    @Override
    public SpreadsheetCellReferenceToCurrencyMap createMap() {
        return SpreadsheetCellReferenceToCurrencyMap.with(MAP);
    }
    ...
    @Override
    public SpreadsheetCellReferenceToCurrencyMap unmarshall(final JsonNode json,
                                                                   final JsonNodeUnmarshallContext context) {
        return SpreadsheetCellReferenceToCurrencyMap.unmarshall(
            json,
            context
        );
    }
    ...
    @Override
    public SpreadsheetCellReferenceToCurrencyMap createJsonNodeMarshallingValue() {
    ...
    public void testUrlFragment() {
        this.urlFragmentAndCheck(
            this.createMap(),
            "%7B%0A%20%20%22A1%22:%20%22AUD%22,%0A%20%20%22A2%22:%20null%0A%7D"
        );
    }
    ...
    @Override
    public Class<SpreadsheetCellReferenceToCurrencyMap> type() {
        return SpreadsheetCellReferenceToCurrencyMap.class;
    }
