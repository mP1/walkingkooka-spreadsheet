    ...
    public void testToString() {
        this.toStringAndCheck(
            ...
            "serverUrl=https://example.com/path123 \"\n" +
                ...
                "  \"converters\": \"basic, boolean, boolean-to-text, collection, color, color-to-color, color-to-number, date-time, date-time-symbols, decimal-number-symbols, environment, error-throwing, error-to-number, expression, form-and-validation, format-pattern-to-string, general, has-style-to-style, json, jsonTo, locale, null-to-number, number, number-to-color, number-to-number, number-to-text, plugins, selection-to-selection, selection-to-text, simple, spreadsheet-cell-to, spreadsheet-metadata, spreadsheet-value, style, system, template, text, text-node, text-to-color, text-to-environment-value-name, text-to-error, text-to-expression, text-to-form-name, text-to-json, text-to-locale, text-to-selection, text-to-spreadsheet-color-name, text-to-spreadsheet-formatter-selector, text-to-spreadsheet-id, text-to-spreadsheet-metadata, text-to-spreadsheet-metadata-color, text-to-spreadsheet-metadata-property-name, text-to-spreadsheet-name, text-to-spreadsheet-text, text-to-template-value-name, text-to-text, text-to-text-node, text-to-text-style, text-to-text-style-property-name, text-to-url, text-to-validation-error, text-to-validator-selector, text-to-value-type, to-boolean, to-json, to-number, to-styleable, to-text-node, to-validation-error-list, url, url-to-hyperlink, url-to-image\",\n" +
