    ...
    public void testToString() {
        this.toStringAndCheck(
                ...
                "serverUrl=https://example.com/path123 \"\n" +
                        ...
                        "  \"converters\": \"basic, collection, error-throwing, error-to-number, format-pattern-to-string, general, has-style-to-style, jsonTo, null-to-number, number-to-number, selection-to-selection, selection-to-text, simple, spreadsheet-cell-to, text-to-error, text-to-expression, text-to-form-name, text-to-json, text-to-selection, text-to-spreadsheet-color-name, text-to-spreadsheet-id, text-to-spreadsheet-metadata, text-to-spreadsheet-metadata-color, text-to-spreadsheet-metadata-property-name, text-to-spreadsheet-name, text-to-spreadsheet-text, text-to-text, text-to-text-node, text-to-text-style, text-to-text-style-property-name, text-to-url, text-to-validation-error, text-to-validator-selector, text-to-value-type, to-json, to-text-node, url-to-hyperlink, url-to-image\",\n" +
