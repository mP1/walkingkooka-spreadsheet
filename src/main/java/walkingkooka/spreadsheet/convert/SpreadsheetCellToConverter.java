 ...
 */
final class SpreadsheetCellToConverter implements Converter<SpreadsheetConverterContext> {

    /**
     * Singleton
     */
    final static SpreadsheetCellToConverter INSTANCE = new SpreadsheetCellToConverter();

    private SpreadsheetCellToConverter() {
    }
