...
final class SpreadsheetConvertersConverterProvider extends SpreadsheetConvertersConverterProviderGwt
    ...
    private final static String CURRENCY_CODE_TO_CURRENCY_STRING = "currency-code-to-currency";

    final static ConverterName CURRENCY_CODE_TO_CURRENCY = ConverterName.with(CURRENCY_CODE_TO_CURRENCY_STRING);
    
    private final static String CURRENCY_VALUE_TO_STRING = "currency-value-to";
    ...
    private final static String PROPERTIES_TO_TEXT_STYLE_STRING = "properties-to-text-style";
    ...
    private final static String SPREADSHEET_ID_TO_SPREADSHEET_METADATA_STRING = "spreadsheet-id-to-spreadsheet-metadata";

    final static ConverterName SPREADSHEET_ID_TO_SPREADSHEET_METADATA = ConverterName.with(SPREADSHEET_ID_TO_SPREADSHEET_METADATA_STRING);
    ...
    private final static String STORAGE_BINARY_TO_STORAGE_VALUE_ENVIRONMENT_STRING = "storage-binary-to-storage-value-environment";

    final static ConverterName STORAGE_BINARY_TO_STORAGE_VALUE_ENVIRONMENT = ConverterName.with(STORAGE_BINARY_TO_STORAGE_VALUE_ENVIRONMENT_STRING);

    private final static String STORAGE_BINARY_TO_STORAGE_VALUE_EXPRESSION_STRING = "storage-binary-to-storage-value-expression";

    final static ConverterName STORAGE_BINARY_TO_STORAGE_VALUE_EXPRESSION = ConverterName.with(STORAGE_BINARY_TO_STORAGE_VALUE_EXPRESSION_STRING);

    private final static String STORAGE_BINARY_TO_STORAGE_VALUE_JSON_STRING = "storage-binary-to-storage-value-json";

    final static ConverterName STORAGE_BINARY_TO_STORAGE_VALUE_JSON = ConverterName.with(STORAGE_BINARY_TO_STORAGE_VALUE_JSON_STRING);

    private final static String STORAGE_BINARY_TO_STORAGE_VALUE_PROPERTIES_STRING = "storage-binary-to-storage-value-properties";

    final static ConverterName STORAGE_BINARY_TO_STORAGE_VALUE_PROPERTIES = ConverterName.with(STORAGE_BINARY_TO_STORAGE_VALUE_PROPERTIES_STRING);

    private final static String STORAGE_BINARY_TO_STORAGE_VALUE_TSV_STRING = "storage-binary-to-storage-value-tsv";

    final static ConverterName STORAGE_BINARY_TO_STORAGE_VALUE_TSV = ConverterName.with(STORAGE_BINARY_TO_STORAGE_VALUE_TSV_STRING);

    private final static String STORAGE_BINARY_TO_STORAGE_VALUE_TXT_STRING = "storage-binary-to-storage-value-txt";

    final static ConverterName STORAGE_BINARY_TO_STORAGE_VALUE_TXT = ConverterName.with(STORAGE_BINARY_TO_STORAGE_VALUE_TXT_STRING);
    ...
    private final static String STORAGE_VALUE_TO_STORAGE_BINARY_BINARY_STRING = "storage-value-to-storage-binary-binary";

    final static ConverterName STORAGE_VALUE_TO_STORAGE_BINARY_BINARY = ConverterName.with(STORAGE_VALUE_TO_STORAGE_BINARY_BINARY_STRING);

    private final static String STORAGE_VALUE_TO_STORAGE_BINARY_CSV_STRING = "storage-value-to-storage-binary-csv";
    ...
    private final static String STORAGE_VALUE_TO_STORAGE_BINARY_PROPERTIES_STRING = "storage-value-to-storage-binary-properties";
    ...
    private final static String STORAGE_VALUE_TO_STORAGE_BINARY_TXT_STRING = "storage-value-to-storage-binary-txt";

    final static ConverterName STORAGE_VALUE_TO_STORAGE_BINARY_TXT = ConverterName.with(STORAGE_VALUE_TO_STORAGE_BINARY_TXT_STRING);
    ...
    private final static String TEXT_TO_BORDER_STRING = "text-to-border";
    ...
    private final static String TEXT_TO_ENVIRONMENT_STRING = "text-to-environment";

    final static ConverterName TEXT_TO_ENVIRONMENT = ConverterName.with(TEXT_TO_ENVIRONMENT_STRING);
    ...
    private final static String TEXT_TO_JSON_SELECTOR_STRING = "text-to-json-selector";

    final static ConverterName TEXT_TO_JSON_SELECTOR = ConverterName.with(TEXT_TO_JSON_SELECTOR_STRING);
    ...
    private final static String TEXT_TO_PADDING_STRING = "text-to-padding";
    ...
    final static ConverterInfoSet INFOS = ConverterInfoSet.with(
        Sets.of(
            ...
            converterInfo(STORAGE_BINARY_TO_STORAGE_VALUE_ENVIRONMENT),
            converterInfo(STORAGE_BINARY_TO_STORAGE_VALUE_EXPRESSION),
            converterInfo(STORAGE_BINARY_TO_STORAGE_VALUE_JSON),
            converterInfo(STORAGE_BINARY_TO_STORAGE_VALUE_PROPERTIES),
            converterInfo(STORAGE_BINARY_TO_STORAGE_VALUE_TSV),
            converterInfo(STORAGE_BINARY_TO_STORAGE_VALUE_TXT),
            ...
            converterInfo(STORAGE_VALUE_TO_STORAGE_BINARY_TXT),
            converterInfo(STYLE),
            ...
            converterInfo(TEXT_TO_ENVIRONMENT),
            ...
            converterInfo(TEXT_TO_JSON_SELECTOR),
