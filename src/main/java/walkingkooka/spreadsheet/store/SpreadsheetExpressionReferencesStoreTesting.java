...
public interface SpreadsheetExpressionReferencesStoreTesting<S extends SpreadsheetExpressionReferencesStore<T>,
    ...
    default <TT extends SpreadsheetExpressionReference> void loadAndCheck(final SpreadsheetExpressionReferencesStore<TT> store,
        ...
        for (SpreadsheetCellReference cell : expected) {
            final Set<TT> references = store.findIdsByValue(
                cell,
                0,
                Integer.MAX_VALUE
            );
    ...
    @Test
    default void testFindIdsByValueFails() {
        assertThrows(
            NullPointerException.class,
            () -> this.createStore()
                .findIdsByValue(
    ...
    @SuppressWarnings("unchecked")
    default <TT extends SpreadsheetExpressionReference> void findIdsByValueAndCheck(final SpreadsheetExpressionReferencesStore<TT> store,
