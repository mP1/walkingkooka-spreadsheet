...
/**
 * When run prints out a javascript expression that accepts a style property and returns the matching enum class.
 */
public final class TextStylePropertyNameToEnumValuesFunctionJavaScriptSourceTool {
    ...
    public static void main(final String[] args) {
        try (final IndentingPrinter printer = Printers.sysOut().indenting(Indentation.with("  "))) {
            ...
            printer.println("expression stylePropertyNameToEnum(property) {");
            printer.indent();
            {
