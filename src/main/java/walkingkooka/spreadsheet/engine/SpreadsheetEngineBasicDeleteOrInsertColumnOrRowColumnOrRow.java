 ...
 */
abstract class SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow {

    /**
     * Package private to limit subclassing.
     */
    SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow(final int value,
                                                               final int count,
    ...
    final void delete() {
        if (this.count > 0) {
            SpreadsheetEngineBasicDeleteOrInsertColumnOrRowDelete.delete(this);
        }
    }

    final void insert() {
        if (this.count > 0) {
            SpreadsheetEngineBasicDeleteOrInsertColumnOrRowInsert.insert(this);
        }
    }
...
//    // cell reference.................................................................................................
    ...
    final void deleteOrFixLabelMapping(final SpreadsheetLabelMapping mapping) {
        new SpreadsheetSelectionVisitor() {
            ...
            protected void visit(final SpreadsheetCellReference cell) {
                SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow.this.deleteOrFixSpreadsheetCellReference(cell, mapping);
            }
            ...
            protected void visit(final SpreadsheetCellRangeReference cellRange) {
                SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow.this.deleteOrFixSpreadsheetCellRange(cellRange, mapping);
            }
    ...
    final void insertFixLabelMapping(final SpreadsheetLabelMapping mapping) {
        new SpreadsheetSelectionVisitor() {
            @Override
            protected void visit(final SpreadsheetCellReference cell) {
                SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow.this.insertFixSpreadsheetCellReference(cell, mapping);
            }
            ...
            @Override
            protected void visit(final SpreadsheetCellRangeReference cellRange) {
                SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow.this.insertFixSpreadsheetCellRange(cellRange, mapping);
            }
        }.accept(mapping.reference());
    }
    ...
    SpreadsheetEngineBasicDeleteOrInsertColumnOrRow deleteOrInsert;
}
