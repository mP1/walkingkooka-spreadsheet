 ...
 */
final class SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRowRow extends SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow {

    static SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRowRow with(final int value,
                                                                              final int count,
                                                                              final SpreadsheetEngineBasic engine,
                                                                              final SpreadsheetEngineContext context) {
        return new SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRowRow(value, count, engine, context);
    }

    /**
     * Private ctor use static factory.
     */
    private SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRowRow(final int value,
                                                                          final int count,
                                                                          final SpreadsheetEngineBasic engine,
                                                                          final SpreadsheetEngineContext context) {
