 ...
 */
enum SpreadsheetEngineBasicChangesMode {
    ...
    final SpreadsheetEngineBasicChanges changes(final SpreadsheetEngineBasic engine,
    ...
    /**
     * Factory that creates a {@link SpreadsheetEngineBasicChanges}
     */
    final SpreadsheetEngineBasicChanges changes(final SpreadsheetEngineBasic engine,
                                                final SpreadsheetEngineEvaluation evaluation,
                                                final Set<SpreadsheetDeltaProperties> deltaProperties,
                                                final SpreadsheetEngineContext context) {
        return SpreadsheetEngineBasicChanges.with(
            engine,
            evaluation,
            deltaProperties,
            this,
