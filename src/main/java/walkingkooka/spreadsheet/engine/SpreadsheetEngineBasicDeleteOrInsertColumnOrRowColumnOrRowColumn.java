 ...
 */
final class SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRowColumn extends SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow {

    static SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRowColumn with(final int value,
                                                                                 final int count,
                                                                                 final SpreadsheetEngineBasic engine,
                                                                                 final SpreadsheetEngineContext context) {
        return new SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRowColumn(value, count, engine, context);
    }

    /**
     * Private ctor use static factory.
     */
    private SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRowColumn(final int value,
                                                                             final int count,
                                                                             final SpreadsheetEngineBasic engine,
                                                                             final SpreadsheetEngineContext context) {
