 ...
 */
enum SpreadsheetEngineBasicChangesCacheStatusCell implements SpreadsheetEngineBasicChangesCacheStatus<SpreadsheetCellReference> {
    ...
    SpreadsheetEngineBasicChangesCacheStatusCell(final int priority) {
    ...
    @Override
    public SpreadsheetEngineBasicChangesCacheStatusCell loading() {
        return this.isReference ?
            REFERENCE_LOADING :
            LOADING;
    }
    ...
    @Override
    public SpreadsheetEngineBasicChangesCacheStatusCell loaded() {
        return this.isReference ?
            REFERENCE_LOADED :
            LOADED;
    }
    ...
    @Override
    public final SpreadsheetEngineBasicChangesCacheStatusCell saved() {
        return this.isReference ?
            REFERENCE_SAVED :
            SAVED;
    }
    ...
    @Override
    public final SpreadsheetEngineBasicChangesCacheStatusCell deleted() {
        return this.isReference ?
            REFERENCE_DELETED :
            DELETED;
    }
    ...
    @Override
    public final SpreadsheetEngineBasicChangesCacheStatusCell forceReferencesRefresh() {
        final SpreadsheetEngineBasicChangesCacheStatusCell newStatus;
    ...
    @Override
    public final SpreadsheetEngineBasicChangesCacheStatusCell referencesRefreshed() {
        final SpreadsheetEngineBasicChangesCacheStatusCell newStatus;
    ...
    @Override
    public SpreadsheetEngineBasicChangesCacheStatusCell toNonReference() {
    ...
    private SpreadsheetEngineBasicChangesCacheStatusCell nonReference;
