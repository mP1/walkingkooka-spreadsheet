 ...
 */
abstract class SpreadsheetEngineBasicDeleteOrInsertColumnOrRow {

    SpreadsheetEngineBasicDeleteOrInsertColumnOrRow(final SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow columnOrRow) {
        super();
        this.columnOrRow = columnOrRow;
        columnOrRow.deleteOrInsert = this;
    }

    abstract boolean isColumnDeleted(final ColumnSpreadsheetFormulaParserToken column);

    abstract boolean isRowDeleted(final RowSpreadsheetFormulaParserToken row);

    abstract int fixColumnOrRowReference(final int count);

    abstract void fixLabelMapping(final SpreadsheetLabelMapping mapping);

    final SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow columnOrRow;
}
