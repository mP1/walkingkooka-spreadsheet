 ...
 */
final class SpreadsheetEngineBasicDeleteOrInsertColumnOrRowDelete extends SpreadsheetEngineBasicDeleteOrInsertColumnOrRow {

    static void delete(final SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow columnOrRow) {
        new SpreadsheetEngineBasicDeleteOrInsertColumnOrRowDelete(columnOrRow)
            .delete0();
    }

    private SpreadsheetEngineBasicDeleteOrInsertColumnOrRowDelete(final SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow columnOrRow) {
        super(columnOrRow);
    }
