 ...
 */
final class SpreadsheetEngineBasicChangesAddFormulaReferenceSpreadsheetSelectionVisitor extends SpreadsheetSelectionVisitor {

    static SpreadsheetEngineBasicChangesAddFormulaReferenceSpreadsheetSelectionVisitor with(final SpreadsheetCellReference cell,
                                                                                            final SpreadsheetStoreRepository repository) {
        return new SpreadsheetEngineBasicChangesAddFormulaReferenceSpreadsheetSelectionVisitor(
            cell,
            repository
        );
    }
    ...
    // VisibleForTesting
    SpreadsheetEngineBasicChangesAddFormulaReferenceSpreadsheetSelectionVisitor(final SpreadsheetCellReference cell,
                                                                                final SpreadsheetStoreRepository repository) {
        super();
        this.cell = cell;
