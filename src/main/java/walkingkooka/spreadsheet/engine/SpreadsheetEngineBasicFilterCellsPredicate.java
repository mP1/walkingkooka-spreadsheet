...
/**
 * This {@link Predicate} is used by {@link SpreadsheetEngineBasic#filterCells(Set, ValueType, Expression, SpreadsheetEngineContext)} to filter each and every {@link SpreadsheetCell}.
 ...
 */
final class SpreadsheetEngineBasicFilterCellsPredicate implements Predicate<SpreadsheetCell> {

    static SpreadsheetEngineBasicFilterCellsPredicate with(final ValueType valueType,
                                                           final Expression expression,
                                                           final SpreadsheetEngineContext context,
                                                           final SpreadsheetExpressionReferenceLoader loader) {
        return new SpreadsheetEngineBasicFilterCellsPredicate(
            valueType,
            expression,
            context,
            loader
    ...
    private SpreadsheetEngineBasicFilterCellsPredicate(final ValueType valueType,
                                                       final Expression expression,
                                                       final SpreadsheetEngineContext context,
                                                       final SpreadsheetExpressionReferenceLoader loader) {
