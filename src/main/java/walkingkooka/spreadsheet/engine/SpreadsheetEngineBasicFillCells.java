...
final class SpreadsheetEngineBasicFillCells {
    ...
    SpreadsheetEngineBasicFillCells(final SpreadsheetEngineBasic engine,
                                    final SpreadsheetEngineBasicChanges changes,
                                    final SpreadsheetEngineContext context) {
        super();
        this.engine = engine;
    ...
    private void saveCell(final SpreadsheetCell cell,
        ...
        final SpreadsheetEngineBasic engine = this.engine;
