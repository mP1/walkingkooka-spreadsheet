 ...
 */
enum SpreadsheetEngineBasicChangesCacheStatusLabel implements SpreadsheetEngineBasicChangesCacheStatus<SpreadsheetLabelName> {
    ...
    SpreadsheetEngineBasicChangesCacheStatusLabel(final int priority) {
    ...
    @Override
    public SpreadsheetEngineBasicChangesCacheStatusLabel loading() {
        throw new UnsupportedOperationException();
    }

    @Override
    public SpreadsheetEngineBasicChangesCacheStatusLabel loaded() {
        return this.isReference ?
            REFERENCE_LOADED :
            LOADED;
    }
    ...
    @Override
    public final SpreadsheetEngineBasicChangesCacheStatusLabel saved() {
        return this.isReference ?
            REFERENCE_SAVED :
            SAVED;
    }
    ...
    @Override
    public final SpreadsheetEngineBasicChangesCacheStatusLabel deleted() {
        return this.isReference ?
            REFERENCE_DELETED :
            DELETED;
    }
    ...
    @Override
    public final SpreadsheetEngineBasicChangesCacheStatusLabel forceReferencesRefresh() {
        final SpreadsheetEngineBasicChangesCacheStatusLabel newStatus;
    ...
    @Override
    public final SpreadsheetEngineBasicChangesCacheStatusLabel referencesRefreshed() {
        final SpreadsheetEngineBasicChangesCacheStatusLabel newStatus;
    ...
    @Override
    public SpreadsheetEngineBasicChangesCacheStatusLabel toNonReference() {
    ...
    private SpreadsheetEngineBasicChangesCacheStatusLabel nonReference;
