 ...
 */
final class SpreadsheetEngineBasicDeleteOrInsertColumnOrRowInsert extends SpreadsheetEngineBasicDeleteOrInsertColumnOrRow {

    static void insert(final SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow columnOrRow) {
        new SpreadsheetEngineBasicDeleteOrInsertColumnOrRowInsert(columnOrRow).insert0();
    }

    private SpreadsheetEngineBasicDeleteOrInsertColumnOrRowInsert(final SpreadsheetEngineBasicDeleteOrInsertColumnOrRowColumnOrRow columnOrRow) {
        super(columnOrRow);
    }
