...
/**
 * This {@link Predicate} is used by {@link BasicSpreadsheetEngine#filterCells(Set, ValueType, Expression, SpreadsheetEngineContext)} to filter each and every {@link SpreadsheetCell}.
...
final class BasicSpreadsheetEngineFilterCellsPredicate implements Predicate<SpreadsheetCell> {
    ...
    static BasicSpreadsheetEngineFilterCellsPredicate with(final ValueType valueType,
    ...
    private BasicSpreadsheetEngineFilterCellsPredicate(final ValueType valueType,
                                                       final Expression expression,
                                                       final SpreadsheetEngineContext context,
                                                       final SpreadsheetExpressionReferenceLoader loader) {
