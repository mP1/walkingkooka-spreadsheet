...
/**
 * Base class for a status that accompanies a {@link SpreadsheetEngineBasicChangesCache}.
 */
interface SpreadsheetEngineBasicChangesCacheStatus<S extends SpreadsheetSelection> {
    ...
    SpreadsheetEngineBasicChangesCacheStatus<S> toNonReference();

    SpreadsheetEngineBasicChangesCacheStatus<S> loading();

    /**
     * Helpers transition UNLOADED to LOADED, all other status should throw an {@link Error}.
     */
    SpreadsheetEngineBasicChangesCacheStatus<S> loaded();

    SpreadsheetEngineBasicChangesCacheStatus<S> saved();

    SpreadsheetEngineBasicChangesCacheStatus<S> deleted();

    SpreadsheetEngineBasicChangesCacheStatus<S> forceReferencesRefresh();

    SpreadsheetEngineBasicChangesCacheStatus<S> referencesRefreshed();
