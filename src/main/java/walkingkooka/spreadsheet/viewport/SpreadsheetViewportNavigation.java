...
public abstract class SpreadsheetViewportNavigation implements HasText {
     ...
     */
    public static SpreadsheetViewportNavigation extendMoveDown() {
     ...
     */
    public static SpreadsheetViewportNavigation extendMoveLeft() {
     ...
     */
    public static SpreadsheetViewportNavigation extendMoveRight() {
