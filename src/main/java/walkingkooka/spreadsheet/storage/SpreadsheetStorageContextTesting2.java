...
public interface SpreadsheetStorageContextTesting2<C extends SpreadsheetStorageContext> extends SpreadsheetStorageContextTesting,
    ...
    @Test
    default void testAddLabelWatcherWithNullWatcherFails() {
        assertThrows(
            NullPointerException.class,
            () -> this.createContext()
                .addLabelWatcher(null)
        );
    }
    ...
    @Test
    default void testAddLabelWatcherOnceWithNullWatcherFails() {
        assertThrows(
            NullPointerException.class,
            () -> this.createContext()
                .addLabelWatcherOnce(null)
        );
    }
