...
public interface SpreadsheetStorageContextTesting2<C extends SpreadsheetStorageContext> extends SpreadsheetStorageContextTesting,
    ...
    @Test
    default void testAddFormStoreWatcherWithNullWatcherFails() {
        assertThrows(
            NullPointerException.class,
            () -> this.createContext()
                .addFormStoreWatcher(null)
        );
    }
    ...
    @Test
    default void testAddFormStoreWatcherOnceWithNullWatcherFails() {
        assertThrows(
            NullPointerException.class,
            () -> this.createContext()
                .addFormStoreWatcherOnce(null)
        );
    }
    ...
    @Test
    default void testAddLabelStoreWatcherWithNullWatcherFails() {
        assertThrows(
            NullPointerException.class,
            () -> this.createContext()
                .addLabelStoreWatcher(null)
        );
    }
    ...
    @Test
    default void testAddLabelStoreWatcherOnceWithNullWatcherFails() {
        assertThrows(
            NullPointerException.class,
            () -> this.createContext()
                .addLabelStoreWatcherOnce(null)
        );
    }
