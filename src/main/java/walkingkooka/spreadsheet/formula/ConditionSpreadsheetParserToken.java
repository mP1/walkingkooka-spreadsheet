 ...
 */
abstract public class ConditionSpreadsheetParserToken extends BinarySpreadsheetParserToken {

    ConditionSpreadsheetParserToken(final List<ParserToken> value, final String text) {
        super(value, text);
    }
