...
public final class SpreadsheetFormula implements CanBeEmpty,
     ...
     */
    public SpreadsheetFormula setValueType(final Optional<ValueType> valueType) {
    ...
    /**
     * If any present error is a {@link SpreadsheetError#isParser()} it will be returned.
     */
    public Optional<SpreadsheetError> parserError() {
        return this.error.filter(SpreadsheetError::isParser);
    }
    ...
    static SpreadsheetFormula unmarshall(final JsonNode node,
        ...
        Optional<ValueType> valueType = NO_VALUE_TYPE;
        Object value = null;
