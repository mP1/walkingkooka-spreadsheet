 ...
 */
public final class ErrorSpreadsheetFormulaParserToken extends NonSymbolSpreadsheetFormulaParserToken<SpreadsheetError> {
    ...
    private ErrorSpreadsheetFormulaParserToken(final SpreadsheetError value,
                                               final String text) {
        super(value, text);
    }
