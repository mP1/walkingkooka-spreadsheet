 ...
 */
public final class GreaterThanEqualsSymbolSpreadsheetFormulaParserToken extends SymbolSpreadsheetFormulaParserToken {
    ...
    private GreaterThanEqualsSymbolSpreadsheetFormulaParserToken(final String value, final String text) {
        super(value, text);
    }
