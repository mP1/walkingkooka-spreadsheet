 ...
 */
public final class ConditionRightGreaterThanSpreadsheetFormulaParserToken extends ConditionRightSpreadsheetFormulaParserToken {
    ...
    private ConditionRightGreaterThanSpreadsheetFormulaParserToken(final List<ParserToken> value, final String text) {
        super(value, text);
    }
