...
public final class EqualsSpreadsheetFormulaParserToken extends ConditionSpreadsheetFormulaParserToken {
    ...
    static EqualsSpreadsheetFormulaParserToken with(final List<ParserToken> value, final String text) {
        return new EqualsSpreadsheetFormulaParserToken(Lists.immutable(value), checkText(text));
    }

    private EqualsSpreadsheetFormulaParserToken(final List<ParserToken> value, final String text) {
        super(value, text);
    }
