 ...
 */
public final class WhitespaceSpreadsheetFormulaParserToken extends SymbolSpreadsheetFormulaParserToken {
    ...
    private WhitespaceSpreadsheetFormulaParserToken(final String value, final String text) {
        super(value, text);
    }
