 ...
 */
public final class MultiplySymbolSpreadsheetFormulaParserToken extends SymbolSpreadsheetFormulaParserToken {
    ...
    private MultiplySymbolSpreadsheetFormulaParserToken(final String value, final String text) {
        super(value, text);
    }
