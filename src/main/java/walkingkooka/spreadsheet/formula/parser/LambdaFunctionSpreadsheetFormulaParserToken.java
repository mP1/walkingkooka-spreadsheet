 ...
 */
public final class LambdaFunctionSpreadsheetFormulaParserToken extends FunctionSpreadsheetFormulaParserToken {
    ...
    private LambdaFunctionSpreadsheetFormulaParserToken(final List<ParserToken> value,
                                                        final String text) {
        super(value, text);
    ...
    public FunctionParametersSpreadsheetFormulaParserToken parameterValues() {
        return this.parameterValues;
    }

    private final FunctionParametersSpreadsheetFormulaParserToken parameterValues;
