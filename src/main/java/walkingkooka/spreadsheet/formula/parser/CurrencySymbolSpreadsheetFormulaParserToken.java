 ...
 */
public final class CurrencySymbolSpreadsheetFormulaParserToken extends SymbolSpreadsheetFormulaParserToken {
    ...
    private CurrencySymbolSpreadsheetFormulaParserToken(final String value, final String text) {
        super(value, text);
    }
