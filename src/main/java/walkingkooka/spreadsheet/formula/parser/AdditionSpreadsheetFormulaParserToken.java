...
public final class AdditionSpreadsheetFormulaParserToken extends ArithmeticSpreadsheetFormulaParserToken {
    ...
    static AdditionSpreadsheetFormulaParserToken with(final List<ParserToken> value, final String text) {
        return new AdditionSpreadsheetFormulaParserToken(Lists.immutable(value), checkText(text));
    }

    private AdditionSpreadsheetFormulaParserToken(final List<ParserToken> value, final String text) {
        super(value, text);
    }
