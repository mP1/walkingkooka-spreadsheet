...
/**
 * Holds a boolean value along with the tokens and original text.
 */
public final class BooleanSpreadsheetFormulaParserToken extends ValueSpreadsheetFormulaParserToken {
    ...
    private BooleanSpreadsheetFormulaParserToken(final List<ParserToken> value, final String text) {
        super(value, text);
    }

    /**
     * Returns a {@link boolean} from the tokens in this {@link BooleanSpreadsheetFormulaParserToken}.
     */
