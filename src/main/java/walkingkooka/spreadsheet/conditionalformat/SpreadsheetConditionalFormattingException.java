...
public class SpreadsheetConditionalFormattingException extends SystemException {
    ...
    public SpreadsheetConditionalFormattingException(final String message) {
        super(message);
    }

    public SpreadsheetConditionalFormattingException(final String message, final Throwable cause) {
        super(message, cause);
    }
}
