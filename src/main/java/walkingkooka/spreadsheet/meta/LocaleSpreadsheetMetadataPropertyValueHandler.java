 ...
 */
final class LocaleSpreadsheetMetadataPropertyValueHandler extends SpreadsheetMetadataPropertyValueHandler<Locale> {

    /**
     * A singleton
     */
    static final LocaleSpreadsheetMetadataPropertyValueHandler INSTANCE = new LocaleSpreadsheetMetadataPropertyValueHandler();

    private LocaleSpreadsheetMetadataPropertyValueHandler() {
        super();
    }
