 ...
 */
final class SpreadsheetMetadataPropertyValueHandlerPositiveInteger extends SpreadsheetMetadataPropertyValueHandler<Integer> {

    /**
     * A singleton
     */
    static final SpreadsheetMetadataPropertyValueHandlerPositiveInteger INSTANCE = new SpreadsheetMetadataPropertyValueHandlerPositiveInteger();

    private SpreadsheetMetadataPropertyValueHandlerPositiveInteger() {
        super();
    }
