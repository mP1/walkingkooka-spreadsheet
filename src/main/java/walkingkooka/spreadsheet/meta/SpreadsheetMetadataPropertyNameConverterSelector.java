...
abstract class SpreadsheetMetadataPropertyNameConverterSelector extends SpreadsheetMetadataPropertyName<ConverterSelector> {
    ...
    @Override //
    final Optional<ConverterSelector> extractLocaleAwareValue(final CurrencyLocaleContext context) {
    ...
    @Override //
    final ConverterSelector parseValueTextNonNull(final String value,
