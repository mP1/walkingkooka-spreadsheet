...
abstract class SpreadsheetMetadataPropertyNameSpreadsheetParserSelector extends SpreadsheetMetadataPropertyName<SpreadsheetParserSelector> {
    ...
    @Override //
    final Optional<SpreadsheetParserSelector> extractLocaleAwareValue(final CurrencyLocaleContext context) {
    ...
    @Override //
    final SpreadsheetParserSelector parseValueTextNonNull(final String value,
