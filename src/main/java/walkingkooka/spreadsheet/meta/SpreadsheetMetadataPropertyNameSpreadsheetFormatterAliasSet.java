...
abstract class SpreadsheetMetadataPropertyNameSpreadsheetFormatterAliasSet extends SpreadsheetMetadataPropertyName<SpreadsheetFormatterAliasSet> {
    ...
    @Override
    final SpreadsheetFormatterAliasSet checkValue0(final Object value) {
    ...
    @Override
    public final SpreadsheetFormatterAliasSet parseUrlFragmentSaveValue0(final String value) {
