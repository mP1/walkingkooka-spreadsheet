...
abstract class SpreadsheetMetadataPropertyNameSpreadsheetFormatterAliasSet extends SpreadsheetMetadataPropertyName<SpreadsheetFormatterAliasSet> {
    ...
    @Override //
    final Optional<SpreadsheetFormatterAliasSet> extractLocaleAwareValue(final CurrencyLocaleContext context) {
    ...
    @Override //
    final SpreadsheetFormatterAliasSet parseValueTextNonNull(final String value,
