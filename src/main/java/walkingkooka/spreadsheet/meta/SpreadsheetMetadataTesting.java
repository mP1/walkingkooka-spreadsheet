    ...
    SpreadsheetMetadata METADATA_EN_AU = SpreadsheetMetadata.EMPTY
        ...
        .set(
            ...
            ConverterSelector.parse("collection(" +
                ...
                "spreadsheet-cell-to, " +
                "has-style-to-style, text-to-color, color-to-color, color-to-number, number-to-color, text-to-spreadsheet-color-name, text-to-spreadsheet-formatter-selector, text-to-spreadsheet-metadata-color, text-to-spreadsheet-text, text-to-text-node, text-to-text-style, text-to-text-style-property-name, to-styleable, to-text-node, url-to-hyperlink, url-to-image, " +
                "general)"
            )
        ).set(
