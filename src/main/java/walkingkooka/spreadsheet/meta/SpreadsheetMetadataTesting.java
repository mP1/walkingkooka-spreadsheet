...
public interface SpreadsheetMetadataTesting extends BinaryTextContextTesting,
    ...
    SpreadsheetMetadata METADATA_EN_AU = SpreadsheetMetadata.EMPTY
        .set(
            ...
            SpreadsheetComparatorNameList.parse("background-color, custom-list, custom-list-case-insensitive, date, datetime, day-of-month, day-of-year, hour-of-ampm, hour-of-day, minute-of-hour, month-of-year, nano-of-second, number, seconds-of-minute, text, text-case-insensitive, time, year")
        ).set(
