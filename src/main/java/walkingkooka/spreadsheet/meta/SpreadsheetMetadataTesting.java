...
public interface SpreadsheetMetadataTesting extends BinaryTextContextTesting,
    ...
    SpreadsheetMetadata METADATA_EN_AU = SpreadsheetMetadata.EMPTY
        .set(
            ...
            SpreadsheetComparatorNameList.parse("background-color, border-bottom-color, border-color, border-left-color, border-right-color, border-top-color, color, currency, custom-list, custom-list-case-insensitive, date, datetime, day-of-month, day-of-year, hour-of-ampm, hour-of-day, locale, minute-of-hour, month-of-year, nano-of-second, number, outline-color, seconds-of-minute, text, text-case-insensitive, time, year")
        ).set(
