...
final class SpreadsheetMetadataPropertyNameFrozenRows extends SpreadsheetMetadataPropertyName<SpreadsheetRowRangeReference> {
    ...
    @Override //
    Optional<SpreadsheetRowRangeReference> extractLocaleAwareValue(final CurrencyLocaleContext context) {
    ...
    @Override
    SpreadsheetRowRangeReference parseValueTextNonNull(final String value,
