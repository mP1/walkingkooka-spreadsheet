...
/**
 * A base {@link SpreadsheetMetadataPropertyValueHandler} for all sub classes of {@link SpreadsheetPatterns patterns}.
 */
abstract class SpreadsheetMetadataPropertyValueHandlerSpreadsheetPatterns<P extends SpreadsheetPatterns<? extends SpreadsheetFormatParserToken>> extends SpreadsheetMetadataPropertyValueHandler<P> {

    SpreadsheetMetadataPropertyValueHandlerSpreadsheetPatterns() {
        super();
    }
