 ...
 */
final class SpreadsheetMetadataPropertyValueHandlerSpreadsheetTextFormatterPatternFormat extends SpreadsheetMetadataPropertyValueHandler<SpreadsheetTextFormatterPattern> {

    /**
     * Singleton
     */
    final static SpreadsheetMetadataPropertyValueHandlerSpreadsheetTextFormatterPatternFormat INSTANCE = new SpreadsheetMetadataPropertyValueHandlerSpreadsheetTextFormatterPatternFormat();

    /**
     * Private ctor use singleton
     */
    private SpreadsheetMetadataPropertyValueHandlerSpreadsheetTextFormatterPatternFormat() {
        super();
    }

    @Override
    final void check0(final Object value, final SpreadsheetMetadataPropertyName<?> name) {
        SpreadsheetMetadataPropertyValueHandlerSpreadsheetTextFormatterPatternFormatSpreadsheetFormatParserTokenVisitor.check(name,
