...
final class SpreadsheetMetadataPropertyValueHandlerSpreadsheetTimeParsePatterns extends SpreadsheetMetadataPropertyValueHandlerSpreadsheetParsePatterns<SpreadsheetTimeParsePatterns> {
     ...
     * Singleton
     */
    final static SpreadsheetMetadataPropertyValueHandlerSpreadsheetTimeParsePatterns INSTANCE = new SpreadsheetMetadataPropertyValueHandlerSpreadsheetTimeParsePatterns();
    ...
    @Override
    Class<SpreadsheetTimeParsePatterns> valueType() {
