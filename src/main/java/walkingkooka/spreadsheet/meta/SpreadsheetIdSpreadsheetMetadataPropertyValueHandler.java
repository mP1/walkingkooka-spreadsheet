 ...
 */
final class SpreadsheetIdSpreadsheetMetadataPropertyValueHandler extends SpreadsheetMetadataPropertyValueHandler<SpreadsheetId> {

    /**
     * A singleton
     */
    static final SpreadsheetIdSpreadsheetMetadataPropertyValueHandler INSTANCE = new SpreadsheetIdSpreadsheetMetadataPropertyValueHandler();

    private SpreadsheetIdSpreadsheetMetadataPropertyValueHandler() {
        super();
    }
