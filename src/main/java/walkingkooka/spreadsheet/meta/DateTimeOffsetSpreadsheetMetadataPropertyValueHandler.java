 ...
 */
final class DateTimeOffsetSpreadsheetMetadataPropertyValueHandler extends SpreadsheetMetadataPropertyValueHandler<Long> {

    /**
     * A singleton
     */
    static final DateTimeOffsetSpreadsheetMetadataPropertyValueHandler INSTANCE = new DateTimeOffsetSpreadsheetMetadataPropertyValueHandler();

    private DateTimeOffsetSpreadsheetMetadataPropertyValueHandler() {
        super();
    }
