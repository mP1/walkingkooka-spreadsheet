...
final class SpreadsheetMetadataPropertyValueHandlerSpreadsheetDateTimeParsePatterns extends SpreadsheetMetadataPropertyValueHandlerSpreadsheetPattern<SpreadsheetDateTimeParsePatterns> {
     ...
     * Singleton
     */
    final static SpreadsheetMetadataPropertyValueHandlerSpreadsheetDateTimeParsePatterns INSTANCE = new SpreadsheetMetadataPropertyValueHandlerSpreadsheetDateTimeParsePatterns();

    /**
     * Private ctor
     */
    private SpreadsheetMetadataPropertyValueHandlerSpreadsheetDateTimeParsePatterns() {
        super();
    }

    @Override
    Predicate<Object> valueTypeChecker() {
        return v -> v instanceof SpreadsheetDateTimeParsePatterns;
    }

    @Override
    Class<SpreadsheetDateTimeParsePatterns> valueType() {
