 ...
 */
abstract class SpreadsheetPatternsSpreadsheetMetadataPropertyValueHandler<P extends SpreadsheetPatterns<? extends SpreadsheetFormatParserToken>> extends SpreadsheetMetadataPropertyValueHandler<P> {

    SpreadsheetPatternsSpreadsheetMetadataPropertyValueHandler() {
        super();
    }
