...
/**
 * A {@link SpreadsheetMetadataPropertyValueHandler} for valid {@link String} {@link DateTimeFormatter} patterns.
 */
final class DateTimeFormatterPatternStringSpreadsheetMetadataPropertyValueHandler extends SpreadsheetMetadataPropertyValueHandler<String> {

    /**
     * Singleton
     */
    final static DateTimeFormatterPatternStringSpreadsheetMetadataPropertyValueHandler INSTANCE = new DateTimeFormatterPatternStringSpreadsheetMetadataPropertyValueHandler();

    /**
     * Private ctor use singleton
     */
    private DateTimeFormatterPatternStringSpreadsheetMetadataPropertyValueHandler() {
        super();
    }
