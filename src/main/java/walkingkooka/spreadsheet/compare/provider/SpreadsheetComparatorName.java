...
final public class SpreadsheetComparatorName implements PluginNameLike<SpreadsheetComparatorName> {
    ...
    final static String BORDER_BOTTOM_COLOR_STRING = "border-bottom-color";

    public final static SpreadsheetComparatorName BORDER_BOTTOM_COLOR = registerConstant(BORDER_BOTTOM_COLOR_STRING);

    final static String BORDER_COLOR_STRING = "border-color";

    public final static SpreadsheetComparatorName BORDER_COLOR = registerConstant(BORDER_COLOR_STRING);

    final static String BORDER_LEFT_COLOR_STRING = "border-left-color";

    public final static SpreadsheetComparatorName BORDER_LEFT_COLOR = registerConstant(BORDER_LEFT_COLOR_STRING);

    final static String BORDER_RIGHT_COLOR_STRING = "border-right-color";
    ...
    public final static SpreadsheetComparatorName CURRENCY = registerConstant(CURRENCY_STRING);
    ...
    final static String OUTLINE_COLOR_STRING = "outline-color";
    ...
    private final static String VALIDATOR_STRING = "validator";
    ...
    public static SpreadsheetComparatorName with(final String name) {
        ...
        switch (name) {
            case BACKGROUND_COLOR_STRING:
                ...
                break;
            case BORDER_COLOR_STRING:
                spreadsheetComparatorName = BORDER_COLOR;
                break;
            case BORDER_BOTTOM_COLOR_STRING:
                spreadsheetComparatorName = BORDER_BOTTOM_COLOR;
                break;
            case BORDER_LEFT_COLOR_STRING:
                spreadsheetComparatorName = BORDER_LEFT_COLOR;
                break;
            ...
            case CURRENCY_STRING:
                spreadsheetComparatorName = CURRENCY;
                break;
