 ...
 */
abstract public class BinarySpreadsheetParserToken extends ParentSpreadsheetParserToken {

    BinarySpreadsheetParserToken(final List<ParserToken> value, final String text) {
        super(value, text);
