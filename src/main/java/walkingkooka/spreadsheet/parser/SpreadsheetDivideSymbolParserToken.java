...
public final class SpreadsheetDivideSymbolParserToken extends SpreadsheetSymbolParserToken {
    ...
    static SpreadsheetDivideSymbolParserToken with(final String value,
                                                   final String text) {
        return new SpreadsheetDivideSymbolParserToken(
                checkValue(value),
                checkText(text)
        );
    }
    ...
    @Override
    public Optional<SpreadsheetDivideSymbolParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetDivideSymbolParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetDivideSymbolParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
