...
public final class SpreadsheetPowerSymbolParserToken extends SpreadsheetSymbolParserToken {
    ...
    @Override
    public Optional<SpreadsheetPowerSymbolParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetPowerSymbolParserToken> removeIf(final Predicate<ParserToken> predicate) {
