...
public final class SpreadsheetDoubleQuoteSymbolParserToken extends SpreadsheetSymbolParserToken {
    ...
    @Override
    public Optional<SpreadsheetDoubleQuoteSymbolParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetDoubleQuoteSymbolParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    boolean canBeEqual(final Object other) {
        return other instanceof SpreadsheetDoubleQuoteSymbolParserToken;
    }
}
