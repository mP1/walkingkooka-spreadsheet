 ...
 */
public final class CellRangeSpreadsheetParserToken extends BinarySpreadsheetParserToken
        implements HasSpreadsheetReference<SpreadsheetCellRangeReference> {

    static CellRangeSpreadsheetParserToken with(final List<ParserToken> value, final String text) {
        return new CellRangeSpreadsheetParserToken(copyAndCheckTokens(value), checkText(text));
    }

    private CellRangeSpreadsheetParserToken(final List<ParserToken> value, final String text) {
        super(value, text);
        ...
        final List<CellReferenceSpreadsheetParserToken> components = visitor.components;
    ...
    @Override
    public CellRangeSpreadsheetParserToken setChildren(final List<ParserToken> children) {
        return ParserToken.parentSetChildren(
                this,
                children,
                CellRangeSpreadsheetParserToken::with
        );
    }
