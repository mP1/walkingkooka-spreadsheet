...
public final class SpreadsheetNamedFunctionParserToken extends SpreadsheetParentParserToken {
    ...
    @Override
    public Optional<SpreadsheetNamedFunctionParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetNamedFunctionParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                         final ParserToken token) {
