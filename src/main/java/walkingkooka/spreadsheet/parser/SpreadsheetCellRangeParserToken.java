...
public final class SpreadsheetCellRangeParserToken extends SpreadsheetBinaryParserToken {
    ...
    @Override
    public Optional<SpreadsheetCellRangeParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetCellRangeParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetCellRangeParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
