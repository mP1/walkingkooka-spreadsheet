...
public final class SpreadsheetBetweenSymbolParserToken extends SpreadsheetSymbolParserToken {
    ...
    static SpreadsheetBetweenSymbolParserToken with(final String value,
                                                    final String text) {
        return new SpreadsheetBetweenSymbolParserToken(
                checkValue(value),
                checkText(text)
        );
    }
    ...
    @Override
    public Optional<SpreadsheetBetweenSymbolParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetBetweenSymbolParserToken> removeIf(final Predicate<ParserToken> predicate) {
