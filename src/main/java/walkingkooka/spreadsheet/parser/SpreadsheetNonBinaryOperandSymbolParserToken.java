 ...
 */
abstract class SpreadsheetNonBinaryOperandSymbolParserToken extends SpreadsheetSymbolParserToken {

    SpreadsheetNonBinaryOperandSymbolParserToken(final String value, final String text) {
        super(value, text);
    }
