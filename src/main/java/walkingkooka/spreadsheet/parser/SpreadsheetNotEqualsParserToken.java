...
public final class SpreadsheetNotEqualsParserToken extends SpreadsheetBinaryParserToken {
    ...
    @Override
    public Optional<SpreadsheetNotEqualsParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetNotEqualsParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
