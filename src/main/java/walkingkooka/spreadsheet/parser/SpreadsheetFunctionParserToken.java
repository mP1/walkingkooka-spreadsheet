...
public final class SpreadsheetFunctionParserToken extends SpreadsheetParentParserToken {
    ...
    @Override
    public Optional<SpreadsheetFunctionParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetFunctionParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetFunctionParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                    final Function<ParserToken, ParserToken> mapper) {
