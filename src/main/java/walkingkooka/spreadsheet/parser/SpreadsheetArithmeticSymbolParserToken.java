 ...
 */
abstract class SpreadsheetArithmeticSymbolParserToken extends SpreadsheetBinaryOperandSymbolParserToken {

    SpreadsheetArithmeticSymbolParserToken(final String value, final String text) {
        super(value, text);
    }
