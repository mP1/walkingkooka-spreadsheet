...
public final class SpreadsheetEqualsSymbolParserToken extends SpreadsheetSymbolParserToken {
    ...
    static SpreadsheetEqualsSymbolParserToken with(final String value,
                                                   final String text) {
        return new SpreadsheetEqualsSymbolParserToken(
                checkValue(value),
                checkText(text)
        );
    }
    ...
    @Override
    public Optional<SpreadsheetEqualsSymbolParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetEqualsSymbolParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetEqualsSymbolParserToken replaceIf(final Predicate<ParserToken> predicate,
