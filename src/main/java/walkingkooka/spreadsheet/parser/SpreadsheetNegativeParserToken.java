...
public final class SpreadsheetNegativeParserToken extends SpreadsheetParentParserToken {
    ...
    @Override
    public Optional<SpreadsheetNegativeParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetNegativeParserToken> removeIf(final Predicate<ParserToken> predicate) {
