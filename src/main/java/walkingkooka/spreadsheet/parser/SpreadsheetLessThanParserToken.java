...
public final class SpreadsheetLessThanParserToken extends SpreadsheetBinaryParserToken {
    ...
    @Override
    public Optional<SpreadsheetLessThanParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetLessThanParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetLessThanParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
