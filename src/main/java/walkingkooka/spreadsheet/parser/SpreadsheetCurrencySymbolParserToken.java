...
public final class SpreadsheetCurrencySymbolParserToken extends SpreadsheetSymbolParserToken {
    ...
    @Override
    public Optional<SpreadsheetCurrencySymbolParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetCurrencySymbolParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                          final ParserToken token) {
    ...
    boolean canBeEqual(final Object other) {
        return other instanceof SpreadsheetCurrencySymbolParserToken;
    }
}
