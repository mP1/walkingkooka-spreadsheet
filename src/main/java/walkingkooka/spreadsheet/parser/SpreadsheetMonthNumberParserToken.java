...
public final class SpreadsheetMonthNumberParserToken extends SpreadsheetNonSymbolParserToken<Integer> {
    ...
    @Override
    public Optional<SpreadsheetMonthNumberParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetMonthNumberParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetMonthNumberParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
