...
public final class SpreadsheetApostropheSymbolParserToken extends SpreadsheetSymbolParserToken {
    ...
    @Override
    public Optional<SpreadsheetApostropheSymbolParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetApostropheSymbolParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                            final ParserToken token) {
