 ...
 */
abstract class SpreadsheetPatternsParser<T extends SpreadsheetFormatParserToken> implements Parser<ParserContext> {

    /**
     * Package private to limit sub class.
     */
    SpreadsheetPatternsParser(final SpreadsheetPatterns<T> patterns) {
        super();
    ...
    final SpreadsheetPatterns<T> patterns;
}
