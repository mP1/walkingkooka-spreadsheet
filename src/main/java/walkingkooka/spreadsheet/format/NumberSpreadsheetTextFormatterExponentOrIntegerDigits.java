 ...
 * and adding digits.
 */
abstract class NumberSpreadsheetTextFormatterExponentOrIntegerDigits extends NumberSpreadsheetTextFormatterDigits {

    NumberSpreadsheetTextFormatterExponentOrIntegerDigits(final NumberSpreadsheetTextFormatterMinusSign minusSign,
                                                          final String text) {
        super(text);
     ...
     */
    NumberSpreadsheetTextFormatterMinusSign minusSign;
}
