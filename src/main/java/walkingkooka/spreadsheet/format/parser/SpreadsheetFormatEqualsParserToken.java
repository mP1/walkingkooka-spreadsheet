...
public final class SpreadsheetFormatEqualsParserToken extends SpreadsheetFormatConditionParserToken {
    ...
    @Override
    public SpreadsheetFormatEqualsParserToken removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetFormatEqualsParserToken removeIf(final Predicate<ParserToken> predicate) {
