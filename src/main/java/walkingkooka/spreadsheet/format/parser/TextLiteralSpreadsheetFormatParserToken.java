 ...
 * Holds literal text.
 */
public final class TextLiteralSpreadsheetFormatParserToken extends NonSymbolSpreadsheetFormatParserToken<String> {
    ...
    private TextLiteralSpreadsheetFormatParserToken(final String value, final String text) {
        super(value, text);
    }
