...
public final class FractionSpreadsheetFormatParserToken extends ParentSpreadsheetFormatParserToken {
    ...
    /**
     * Factory that creates a new {@link FractionSpreadsheetFormatParserToken}.
     */
     ...
     */
    private FractionSpreadsheetFormatParserToken(final List<ParserToken> value, final String text) {
        super(value, text);
    }
