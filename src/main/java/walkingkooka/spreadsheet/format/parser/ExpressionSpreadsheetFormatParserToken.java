 ...
 */
public final class ExpressionSpreadsheetFormatParserToken extends ParentSpreadsheetFormatParserToken {

    /**
     * Factory that creates a new {@link ExpressionSpreadsheetFormatParserToken}.
     */
     ...
     */
    private ExpressionSpreadsheetFormatParserToken(final List<ParserToken> value, final String text) {
        super(value, text);
    }
