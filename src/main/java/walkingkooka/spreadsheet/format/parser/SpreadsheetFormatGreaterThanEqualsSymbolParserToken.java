...
public final class SpreadsheetFormatGreaterThanEqualsSymbolParserToken extends SpreadsheetFormatSymbolParserToken {
    ...
    @Override
    public Optional<SpreadsheetFormatGreaterThanEqualsSymbolParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetFormatGreaterThanEqualsSymbolParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
    ...
    @Override
    public SpreadsheetFormatGreaterThanEqualsSymbolParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                                         final ParserToken token) {
