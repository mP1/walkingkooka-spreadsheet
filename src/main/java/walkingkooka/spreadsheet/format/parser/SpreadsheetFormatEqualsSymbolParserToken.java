...
public final class SpreadsheetFormatEqualsSymbolParserToken extends SpreadsheetFormatSymbolParserToken {
    ...
    @Override
    public Optional<SpreadsheetFormatEqualsSymbolParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetFormatEqualsSymbolParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetFormatEqualsSymbolParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
