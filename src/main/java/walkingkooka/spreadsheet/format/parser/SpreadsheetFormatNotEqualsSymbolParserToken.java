...
public final class SpreadsheetFormatNotEqualsSymbolParserToken extends SpreadsheetFormatSymbolParserToken {
    ...
    @Override
    public Optional<SpreadsheetFormatNotEqualsSymbolParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetFormatNotEqualsSymbolParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetFormatNotEqualsSymbolParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
    ...
    @Override
    public SpreadsheetFormatNotEqualsSymbolParserToken replaceIf(final Predicate<ParserToken> predicate,
