...
public final class SpreadsheetFormatPercentParserToken extends SpreadsheetFormatNonSymbolParserToken<String> {
    ...
    @Override
    public Optional<SpreadsheetFormatPercentParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetFormatPercentParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
