 ...
 */
public final class ExponentSpreadsheetFormatParserToken extends ParentSpreadsheetFormatParserToken {

    /**
     * Factory that creates a new {@link ExponentSpreadsheetFormatParserToken}.
     */
     ...
     */
    private ExponentSpreadsheetFormatParserToken(final List<ParserToken> value, final String text) {
        super(value, text);
    }
