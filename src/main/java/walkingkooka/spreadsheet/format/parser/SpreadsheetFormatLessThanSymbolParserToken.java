...
public final class SpreadsheetFormatLessThanSymbolParserToken extends SpreadsheetFormatSymbolParserToken {
    ...
    @Override
    public Optional<SpreadsheetFormatLessThanSymbolParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetFormatLessThanSymbolParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetFormatLessThanSymbolParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
    ...
    @Override
    public SpreadsheetFormatLessThanSymbolParserToken replaceIf(final Predicate<ParserToken> predicate,
                                                                final ParserToken token) {
