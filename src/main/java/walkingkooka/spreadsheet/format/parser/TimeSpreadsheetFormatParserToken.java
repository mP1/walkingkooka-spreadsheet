 ...
 */
public final class TimeSpreadsheetFormatParserToken extends ParentSpreadsheetFormatParserToken {

    /**
     * Factory that creates a new {@link TimeSpreadsheetFormatParserToken}.
     */
     ...
     */
    private TimeSpreadsheetFormatParserToken(final List<ParserToken> value, final String text) {
        super(value, text);
    }
