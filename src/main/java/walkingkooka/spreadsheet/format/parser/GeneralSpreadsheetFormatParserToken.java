 ...
 */
public final class GeneralSpreadsheetFormatParserToken extends ParentSpreadsheetFormatParserToken {

    /**
     * Factory that creates a new {@link GeneralSpreadsheetFormatParserToken}.
     */
     ...
     */
    private GeneralSpreadsheetFormatParserToken(final List<ParserToken> value, final String text) {
        super(value, text);
    }
