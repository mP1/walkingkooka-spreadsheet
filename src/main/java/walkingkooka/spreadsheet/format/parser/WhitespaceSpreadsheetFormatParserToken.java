 ...
 * Holds whitespace
 */
public final class WhitespaceSpreadsheetFormatParserToken extends SymbolSpreadsheetFormatParserToken {
    ...
    private WhitespaceSpreadsheetFormatParserToken(final String value, final String text) {
        super(value, text);
    }
