 ...
 */
public final class DaySpreadsheetFormatParserToken extends NonSymbolSpreadsheetFormatParserToken<String> {

    static DaySpreadsheetFormatParserToken with(final String value, final String text) {
        checkValueAndText(value, text);

        return new DaySpreadsheetFormatParserToken(value, text);
    }

    private DaySpreadsheetFormatParserToken(final String value, final String text) {
        super(value, text);
    }
