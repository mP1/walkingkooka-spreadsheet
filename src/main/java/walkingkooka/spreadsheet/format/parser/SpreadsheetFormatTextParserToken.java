...
public final class SpreadsheetFormatTextParserToken extends SpreadsheetFormatParentParserToken {
    ...
    @Override
    public Optional<SpreadsheetFormatTextParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public Optional<SpreadsheetFormatTextParserToken> removeIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetFormatTextParserToken replaceIf(final Predicate<ParserToken> predicate,
