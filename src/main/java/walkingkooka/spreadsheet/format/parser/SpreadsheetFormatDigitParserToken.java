...
public final class SpreadsheetFormatDigitParserToken extends SpreadsheetFormatNonSymbolParserToken<String> {
    ...
    @Override
    public Optional<SpreadsheetFormatDigitParserToken> removeFirstIf(final Predicate<ParserToken> predicate) {
    ...
    @Override
    public SpreadsheetFormatDigitParserToken replaceFirstIf(final Predicate<ParserToken> predicate,
