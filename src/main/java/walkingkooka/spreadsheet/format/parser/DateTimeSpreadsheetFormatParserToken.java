 ...
 */
public final class DateTimeSpreadsheetFormatParserToken extends ParentSpreadsheetFormatParserToken {

    /**
     * Factory that creates a new {@link DateTimeSpreadsheetFormatParserToken}.
     */
     ...
     */
    private DateTimeSpreadsheetFormatParserToken(final List<ParserToken> value, final String text) {
        super(value, text);
    }
