 ...
 */
enum BigDecimalSpreadsheetTextFormatterThousandsSeparator {
    ...
    abstract void append(final int numberDigitPosition, final BigDecimalSpreadsheetTextFormatterComponentContext context);
}
