 ...
 */
final class SpreadsheetNumberParsePatternConverter implements Converter<ExpressionNumberConverterContext> {

    static SpreadsheetNumberParsePatternConverter with(final SpreadsheetNumberParsePattern pattern) {
        return new SpreadsheetNumberParsePatternConverter(pattern);
    }

    private SpreadsheetNumberParsePatternConverter(final SpreadsheetNumberParsePattern pattern) {
        super();
