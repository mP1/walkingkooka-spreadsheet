 ...
 */
final class LocalDateTimeSpreadsheetTextFormatterAnalysisSpreadsheetFormatParserTokenVisitor extends TextFormatterSpreadsheetFormatParserTokenVisitor {

    /**
     * Creates a {@link LocalDateTimeSpreadsheetTextFormatterAnalysisSpreadsheetFormatParserTokenVisitor}.
     */
    static LocalDateTimeSpreadsheetTextFormatterAnalysisSpreadsheetFormatParserTokenVisitor with() {
     ...
     */
    // @VisibleForTesting
    LocalDateTimeSpreadsheetTextFormatterAnalysisSpreadsheetFormatParserTokenVisitor() {
        super();
