 ...
 */
enum NumberSpreadsheetTextFormatterZero {
    ...
    HASH {
        @Override
        void append(final int textDigitPosition, final NumberSpreadsheetTextFormatterComponentContext context) {
            // nop
        }
    ...
    abstract void append(final int textDigitPosition, final NumberSpreadsheetTextFormatterComponentContext context);
