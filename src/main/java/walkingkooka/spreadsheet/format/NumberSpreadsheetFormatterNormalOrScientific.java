...
enum NumberSpreadsheetFormatterNormalOrScientific {
    ...
    SCENTIFIC {
        ...
        NumberSpreadsheetFormatterContext context(final BigDecimal value,
            ...
            return NumberSpreadsheetFormatterContext.with(
                    NumberSpreadsheetFormatterDigits.integer(NumberSpreadsheetFormatterMinusSign.fromSignum(value.signum()), digits.substring(0, integerDigitCount), formatter.groupSeparator),
