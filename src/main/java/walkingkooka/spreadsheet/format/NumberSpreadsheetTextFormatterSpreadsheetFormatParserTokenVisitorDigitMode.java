 ...
 */
enum NumberSpreadsheetTextFormatterSpreadsheetFormatParserTokenVisitorDigitMode {
    ...
    INTEGER {
        @Override
        void decimalPoint(final NumberSpreadsheetTextFormatterSpreadsheetFormatParserTokenVisitor visitor) {
            visitor.digitMode = FRACTION;
        }

        @Override
        int digitCounterAndIncrement(final NumberSpreadsheetTextFormatterSpreadsheetFormatParserTokenVisitor visitor) {
            if (visitor.comma > 0) {
        ...
        @Override
        void thousands(final NumberSpreadsheetTextFormatterSpreadsheetFormatParserTokenVisitor visitor) {
            visitor.comma++;
        }
    },
    ...
    abstract void decimalPoint(final NumberSpreadsheetTextFormatterSpreadsheetFormatParserTokenVisitor visitor);

    abstract int digitCounterAndIncrement(final NumberSpreadsheetTextFormatterSpreadsheetFormatParserTokenVisitor visitor);

    abstract void exponent(final SpreadsheetFormatExponentParserToken token,
                           final NumberSpreadsheetTextFormatterSpreadsheetFormatParserTokenVisitor visitor);

    abstract void thousands(final NumberSpreadsheetTextFormatterSpreadsheetFormatParserTokenVisitor visitor);
}
