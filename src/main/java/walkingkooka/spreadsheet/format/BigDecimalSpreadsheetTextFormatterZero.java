 ...
 */
enum BigDecimalSpreadsheetTextFormatterZero {
    ...
    HASH {
        @Override
        void append(final int textDigitPosition, final BigDecimalSpreadsheetTextFormatterComponentContext context) {
            // nop
        }
    ...
    abstract void append(final int textDigitPosition, final BigDecimalSpreadsheetTextFormatterComponentContext context);
