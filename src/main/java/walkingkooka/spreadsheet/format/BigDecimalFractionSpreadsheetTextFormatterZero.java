 ...
 */
enum BigDecimalFractionSpreadsheetTextFormatterZero {
    ...
    HASH {
        @Override
        void append(final int textDigitPosition, final BigDecimalFractionSpreadsheetTextFormatterComponentContext context) {
            // nop
        }
    ...
    abstract void append(final int textDigitPosition, final BigDecimalFractionSpreadsheetTextFormatterComponentContext context);
