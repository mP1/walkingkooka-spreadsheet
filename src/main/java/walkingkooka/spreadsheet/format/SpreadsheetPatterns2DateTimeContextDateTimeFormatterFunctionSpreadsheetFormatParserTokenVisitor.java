 ...
 */
final class SpreadsheetPatterns2DateTimeContextDateTimeFormatterFunctionSpreadsheetFormatParserTokenVisitor extends SpreadsheetFormatParserTokenVisitor {
    ...
    static DateTimeFormatter toDateTimeFormatter(final SpreadsheetFormatParserToken token,
        ...
        try {
            final ChronoField hour = ampm ?
                    HOUR_AMPM :
                    HOUR_24;
            final SpreadsheetPatterns2DateTimeContextDateTimeFormatterFunctionSpreadsheetFormatParserTokenVisitor visitor = new SpreadsheetPatterns2DateTimeContextDateTimeFormatterFunctionSpreadsheetFormatParserTokenVisitor(twoDigitYear,
                    hour,
                    token);
    ...
    SpreadsheetPatterns2DateTimeContextDateTimeFormatterFunctionSpreadsheetFormatParserTokenVisitor(final int twoDigitYear,
