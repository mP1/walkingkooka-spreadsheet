...
public final class SpreadsheetExpressionReferenceStores implements PublicStaticHelper {
     ...
     */
    public static <T extends SpreadsheetExpressionReference<T>> SpreadsheetExpressionReferenceStore<T> fake() {
     ...
     */
    public static <T extends SpreadsheetExpressionReference<T>> SpreadsheetExpressionReferenceStore<T> readOnly(final SpreadsheetExpressionReferenceStore<T> store) {
     ...
     */
    public static <T extends SpreadsheetExpressionReference<T>> SpreadsheetExpressionReferenceStore<T> treeMap() {
