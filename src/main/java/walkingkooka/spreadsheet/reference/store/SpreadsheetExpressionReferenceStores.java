...
public final class SpreadsheetExpressionReferenceStores implements PublicStaticHelper {
     ...
     */
    public static <T extends SpreadsheetExpressionReference> SpreadsheetExpressionReferenceStore<T> fake() {
     ...
     */
    public static <T extends SpreadsheetExpressionReference> SpreadsheetExpressionReferenceStore<T> readOnly(final SpreadsheetExpressionReferenceStore<T> store) {
     ...
     */
    public static <T extends SpreadsheetExpressionReference & Comparable<T>> SpreadsheetExpressionReferenceStore<T> treeMap() {
