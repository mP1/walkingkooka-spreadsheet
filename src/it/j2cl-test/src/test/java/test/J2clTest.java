    ...
    private static SpreadsheetMetadata metadata() {
        if (null == metadata) {
            SpreadsheetMetadata m = SpreadsheetMetadata.EMPTY
                ...
                .set(SpreadsheetMetadataPropertyName.FORMATTING_CONVERTER, ConverterSelector.parse("collection(text, boolean, number, date-time, basic, locale, spreadsheet-value, error-throwing, color, expression, environment, currency, plugins, style, text-node, template, net)"))
                .set(SpreadsheetMetadataPropertyName.FORMULA_CONVERTER, ConverterSelector.parse("collection(text, boolean, number, date-time, basic, locale, spreadsheet-value, error-throwing, color, expression, environment, currency, template, net)"))
